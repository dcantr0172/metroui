...
function AutoTabard_OnLoad(this)
	...
	SLASH_AUTOTABARD3 = "/wappenrock";
	SLASH_AUTOTABARD4 = "/wrw";
	...
	AutoTabard_panel=AutoTabard_Frame
        ...
        AutoTabard_panel.name = "Auto Tabard"
...
function AutoTabard_Click(b1, b2)
	...
	if ButtonNumber==AutoTabard_TabardNum then
		...
		if TabardName then
			...
			AutoTabard_Print("|CFFFF0000"..string.format(AutoTabard_TABARDNOTFOUND2, "<tabard("..AutoTabard_RepFactions[ButtonNumber]..")>"))
		end
	end
...
function AutoTabard_InitWindow()
	...
	for n = 1, AutoTabard_TabardNum do
		...
		newFrame = CreateFrame("Frame", name, AutoTabard_Frame, "AutoTabard_FrameTemplate" );
