...
DBM_CORE_COMBAT_STATE_RECOVERED		= "%s已開戰%s, 正在回復計時器..."
...
DBM_CORE_WHISPER_COMBAT_END_WIPE_AT	= "%s在%s(%s)的戰鬥中滅團了。"
...
DBM_CORE_RANGECHECK_OPTION_TEXT			= "顯示文字框架"
DBM_CORE_RANGECHECK_OPTION_BOTH			= "兩者同時顯示"
DBM_CORE_RANGECHECK_OPTION_SPEED	= "更新頻率(需重載)"
DBM_CORE_RANGECHECK_OPTION_SLOW		= "慢速(低CPU佔用)"
...
DBM_CORE_AUTO_TIMER_OPTIONS = {
	...
	fades		= "為$spell:%s消失顯示剩餘時間計時器",
	cd					= "為$spell:%s顯示冷卻計時器",
	cdcount					= "為$spell:%s顯示冷卻計數計時器",
	next					= "為下一次$spell:%s顯示計時器",
	nextcount					= "為下一次$spell:%s顯示計數計時器",
...
DBM_CORE_AUTO_ANNOUNCE_OPTIONS = {
	...
	count					= "為$spell:%s顯示計數警告",
	stack					= "提示$spell:%s的堆疊層數"
}
...
DBM_CORE_AUTO_SPEC_WARN_OPTIONS = {
	...
	move					= "當你中了$spell:%s需要躲開時顯示特別警告",
	run					= "當你中了$spell:%s需要跑開時顯示特別警告",
	cast					= "為$spell:%s正在施放顯示特別警告",
	stack					= "當疊加了>=%d層$spell:%s時顯示特別警告",
	switch		= "為$spell:%s需要切換目標顯示特別警告"
}
...
DBM_CORE_AUTO_SOUND_OPTION_TEXT			= "當你中了$spell:%s時播放\"快跑啊\"音效"
DBM_CORE_AUTO_COUNTDOWN_OPTION_TEXT	= "為$spell:%s施放前播放倒計時音效"
DBM_CORE_AUTO_COUNTOUT_OPTION_TEXT	= "為$spell:%s持續結束前播放倒計時音效"
...
DBM_INSTANCE_INFO_DETAIL_DEBUG		= "發送者: %s 結果類型: %s 副本名稱: %s 副本ID: %s 難度: %d 團隊人數: %d 進度: %s"
...
DBM_INSTANCE_INFO_SHOW_RESULTS		= "已回覆的玩家: %s\n|HDBM:showRaidIdResults|h|cff3588ff[現在顯示結果]|r|h"
