...
local timerRoarCD					= mod:NewCDTimer(19, 109228)
...
local function Phase2Delay()
	...
	sndWOP:Cancel("Interface\\AddOns\\DBM-Core\\extrasounds\\purplecirclesoon.mp3")
	timerBroadsideCD:Cancel()
	timerSapperCD:Cancel()
	timerRoarCD:Start(10)
	sndWOP:Schedule(8, "Interface\\AddOns\\DBM-Core\\extrasounds\\roarsoon.mp3")
	timerTwilightFlamesCD:Start(12)
	timerShockwaveCD:Start(13)
	sndWOP:Schedule(10, "Interface\\AddOns\\DBM-Core\\extrasounds\\wavesoon.mp3")
...
function mod:OnCombatStart(delay)
	...
	sndWOP:Schedule(44-delay, "Interface\\AddOns\\DBM-Core\\extrasounds\\purplecirclesoon.mp3")
...
function mod:SPELL_CAST_START(args)
	if args:IsSpellID(107588) then
		...
		sndWOP:Schedule(31, "Interface\\AddOns\\DBM-Core\\extrasounds\\purplecirclesoon.mp3")
	elseif args:IsSpellID(108046) then
		self:ScheduleMethod(0.2, "ShockwaveTarget")
		timerShockwaveCD:Start()
		sndWOP:Schedule(20, "Interface\\AddOns\\DBM-Core\\extrasounds\\wavesoon.mp3")
...
function mod:SPELL_CAST_SUCCESS(args)
	if args:IsSpellID(108044, 109228, 109229, 109230) then
		warnRoar:Show()
		timerRoarCD:Start()
		sndWOP:Schedule(17, "Interface\\AddOns\\DBM-Core\\extrasounds\\roarsoon.mp3")
	end
end
...
function mod:SPELL_AURA_APPLIED(args)
	...
	elseif args:IsSpellID(110598, 110214) then
		...
		sndWOP:Play("Interface\\AddOns\\DBM-Core\\extrasounds\\shroud.mp3")
...
function mod:UNIT_SPELLCAST_SUCCEEDED(uId, spellName)
	if spellName == GetSpellInfo(107594) then
