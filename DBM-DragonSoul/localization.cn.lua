...
L:SetOptionLocalization({
	...
	SetIconOnShatteringIce		= DBM_CORE_AUTO_ICONS_OPTION_TEXT:format(110888),
...
L:SetOptionLocalization({
	...
	SpecWarnTendril			= "当你没有$spell:109454减益时显示特别警告",--http://ptr.wowhead.com/npc=56188
	InfoFrame				= "在信息框架显示没有$spell:109454的玩家",
