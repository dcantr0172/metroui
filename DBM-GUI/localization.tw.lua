...
L.VictorySound    = "戰鬥勝利或失敗時隨機播放特別音效"
L.UseMasterVolume			= "使用主要聲音頻道來播放音效檔。"
L.DisableCinematics			= "禁止播放遊戲中所有的動畫電影"
L.SKT_Enabled				= "永遠顯示快速擊殺計時器 (覆蓋首領特定的選項)"
L.Latency_Text				= "設定最高延遲同步門檻: %d"

L.ModelOptions				= "3D 模型查看選項"
L.EnableModels				= "在首領選項啟用3D模型"
L.ModelSoundOptions			= "為模型查看器設定音效選項"
L.ModelSoundShort			= "短"
L.ModelSoundLong			= "長"

L.Button_RangeFrame			= "顯示/隱藏距離監視器"
L.Button_RangeRadar			= "顯示/隱藏距離雷達"
L.Button_InfoFrame			= "顯示/隱藏資訊框"
...
L.SpecWarn_LHFrame			= "為特別警告添加窗體閃爍效果"
