...
function ActionBar:GetDefaults()
	...
	local yOffsets = {0,120,160,200,40,80,240,280,320,360}
	defaults.y = yOffsets[self.id]
	local hiddens = {false,true,true,true,false,false,true,true,true,true}
	defaults.hidden = hiddens[self.id]
