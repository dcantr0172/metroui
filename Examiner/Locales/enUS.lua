...
-- All these enchants have had their tooltip text changed
...
--	{ p = "^Surefooted$", s = { "CRIT", "HIT", "SPELLCRIT", "SPELLHIT" }, v = 10 }, -- Boots
--	{ p = "^Icewalker$", s = { "CRIT", "HIT", "SPELLCRIT", "SPELLHIT" }, v = 12 }, -- Boots
--	{ p = "^Accuracy$", s = { "CRIT", "HIT", "SPELLCRIT", "SPELLHIT" }, v = 25 }, -- Weapon
