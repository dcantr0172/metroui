...
mod:CreateButton(PVP,PLAYER_V_PLAYER,L["Honor & Arena Details"]);
mod.canCache = true;
...
for i = 1, 9 do
	...
	if (i <= 3) then
		l:SetText(i == 1 and L["Today"] or i == 2 and L["Yesterday"] or L["Lifetime"]);
...
local labelNames = { L["Games"], L["Played"], L["Wins"], L["Losses"], L["Calculated Points"], L["PR"] };
for i = 1, 3 do
