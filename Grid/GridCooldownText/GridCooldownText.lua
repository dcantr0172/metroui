  ...
  args = {
    ["fontsize"] = {
      ...
      set = function(_, v)
        ...
        GridFrame:WithAllFrames(function (f) f.IconCDText:SetFont(font, v, "OUTLINE") end)
      end,
    },
    ["alpha"] = {
      type = "range",
...
if media then
  GridCooldownText.options.args["font"] = {
    ...
    set = function(_, v)
      ...
      GridFrame:WithAllFrames(function (f) f.IconCDText:SetFont(font, fontsize, "OUTLINE") end)
    end,
  }
end
