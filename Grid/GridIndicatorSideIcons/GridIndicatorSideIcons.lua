...
local options = {--GridIndicatorSideIcons.options = {
	type = "group",
	--inline = true,
	icon = "Interface\\AddOns\\Grid\\GridIndicatorSideIcons\\GridIndicatorSideIcons-icon-TRBL",
	name = L["Icon (Sides)"],
	...
	args = {
		...
		["iconsizetop"] = {
			type = "range",
			icon = "Interface\\AddOns\\Grid\\GridIndicatorSideIcons\\GridIndicatorSideIcons-icon-T",
		...
		["iconsizebottom"] = {
			type = "range",
			icon = "Interface\\AddOns\\Grid\\GridIndicatorSideIcons\\GridIndicatorSideIcons-icon-B",
		...
		["iconsizeleft"] = {
			type = "range",
			icon = "Interface\\AddOns\\Grid\\GridIndicatorSideIcons\\GridIndicatorSideIcons-icon-L",
		...
		["iconsizeright"] = {
			type = "range",
			icon = "Interface\\AddOns\\Grid\\GridIndicatorSideIcons\\GridIndicatorSideIcons-icon-R",
...
--end
do
    local statusmap = GridFrame.defaultDB
    if not statusmap["icontop"] then
        statusmap["icontop"] = {}
        statusmap["iconbottom"] = {}
        statusmap["iconleft"] = {}
...
function GridIndicatorSideIcons:CleanOptionsMenu()
	...
	Grid.options.args.Indicators.args.icontop.icon  = "Interface\\AddOns\\Grid\\GridIndicatorSideIcons\\GridIndicatorSideIcons-icon-T"
	Grid.options.args.Indicators.args.iconbottom.icon = "Interface\\AddOns\\Grid\\GridIndicatorSideIcons\\GridIndicatorSideIcons-icon-B"
	Grid.options.args.Indicators.args.iconleft.icon  = "Interface\\AddOns\\Grid\\GridIndicatorSideIcons\\GridIndicatorSideIcons-icon-L"
	Grid.options.args.Indicators.args.iconright.icon = "Interface\\AddOns\\Grid\\GridIndicatorSideIcons\\GridIndicatorSideIcons-icon-R"
