...
L["Options for assigning statuses to indicators."] = "Grid 指示器的选项"
...
L["Thick"] = "粗"
L["Thin"] = "细"
L["Throttle Updates"] = "团队成员变更刷新"
L["Throttle updates on group changes. This option may cause delays in updating frames, so you should only enable it if you're experiencing temporary freezes or lockups when people join or leave your group."] = "启用此功能可能导致游戏帧数降低,请在遭遇团队成员加入或者离开时候Grid框架无法自动刷新时才启用该项"
...
L["Options for GridStatus."] = 'Grid 状态的选项' 
