...
L["Options for assigning statuses to indicators."] = "Grid 指示器的選項"
L["Options related to bar indicators."] = "條形指示器的選項"
L["Options related to icon indicators."] = "圖標指示器的選項"
L["Options related to text indicators."] = "文字指示器的選項"
...
L["Thick"] = "粗體"
L["Thin"] = "細體"
L["Throttle Updates"] = "團隊成員變更刷新"
L["Throttle updates on group changes. This option may cause delays in updating frames, so you should only enable it if you're experiencing temporary freezes or lockups when people join or leave your group."] = "啟用此選項有可能導致遊戲幀數的下降,請在遭遇團隊成員加入或者離開GRID無法自動刷新時才啟用該項"
...
L["Toggle the font drop shadow effect."] = "開啟或關閉字體陰影效果"
...
L["Minimum Value"] = "最小值"
L["Only show incoming heals greater than this amount."] = "僅顯示大於該數值的治療法術"
