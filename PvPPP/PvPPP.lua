...
local function InitData()
	...
	_G["FlagButton_TANK"]["LM"]:SetText(0)
	_G["FlagButton_TANK"]["BL"]:SetText(0)
	_G["FlagButton_DAMAGER"]["LM"]:SetText(0)
	_G["FlagButton_DAMAGER"]["BL"]:SetText(0)
	_G["FlagButton_HEALER"]["LM"]:SetText(0)
	_G["FlagButton_HEALER"]["BL"]:SetText(0)
...
PVP:RegisterEvent("RAID_ROSTER_UPDATE")
