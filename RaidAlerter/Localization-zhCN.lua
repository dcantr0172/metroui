...
--		"强效力量",			-- [极效力量药剂]buff名和QS祝福重复，取消检测
		"极效坚韧",			--守护药剂：最大生命+350，回血20/5s[极效坚韧药剂]
		"强效思维",			--守护药剂：最大法力+450 [极效思维药剂]
		--CTM新增
		"幽魂药剂",			--战斗药剂：精神+225
		"纳迦药剂",			--战斗药剂：精准+225
		"眼镜蛇药剂",		--战斗药剂：暴击+225
...
--	RAL_TEXT_FUNC_10				= "通报战士的破釜沉舟技能";
	...
	RAL_TEXT_FUNC_46				= "插件内存清理完毕，释放了%sK内存";
...
--	RAL_TEXT_ALERT_22				= "**已启动%s：%s"..RAL_TEXT_ARROW_R.."%s！**";
	...
	RAL_TEXT_ALERT_45				= "**%s 光荣战死（%s）**";
--**<云游山水>光荣战死（血领主曼多基尔[斩首]伤害13825651）**
	...
	RAL_TEXT_RAIDSPELL_1 = {
		...
		{["TEXT"]="烤全龙盛宴",["MATCH"]=1,["TYPE"]="COOKFOOD",["DUR"]=180,},
		{["TEXT"]="地精烤肉野餐",["MATCH"]=1,["TYPE"]="COOKFOOD",["DUR"]=180,},
		{["TEXT"]="海鲜盛宴",["MATCH"]=1,["TYPE"]="COOKFOOD",["DUR"]=180,},
		{["TEXT"]="防护药锅",["MATCH"]=0,["TYPE"]="ELIXIR",["DUR"]=180,},				--各种抗性药锅
		{["TEXT"]="战斗药锅",["MATCH"]=0,["TYPE"]="ELIXIR",["DUR"]=180,},				--战斗药锅, 大号战斗药锅
	...
	RAL_TEXT_SPELL_38				= "保护之手";		--QS单体减伤
	RAL_TEXT_SPELL_39				= "牺牲之手";		--QS单体减伤
	RAL_TEXT_SPELL_40				= "炽热防御者";		--QS加强版圣佑术
	RAL_TEXT_SPELL_41				= "神圣守卫";		--QS群体减伤
	RAL_TEXT_SPELL_42				= "真言术：障";		--MS群体减伤
	RAL_TEXT_SPELL_43				= "痛苦压制";		--MS单体减伤
	RAL_TEXT_SPELL_44				= "集结呐喊";		--ZS群体破釜
	RAL_TEXT_SPELL_45				= "圣疗术";			--QS单体大+
	RAL_TEXT_SPELL_46				= "狂暴回复";		--熊T版破釜
	RAL_TEXT_SPELL_47				= "树皮术";			--XD本体减伤
	RAL_TEXT_SPELL_48				= "复生";			--XD战复
	RAL_TEXT_SPELL_49				= "复活盟友";		--DK战复
	RAL_TEXT_SPELL_50				= "能量灌注";		--戒牧加强技
	RAL_TEXT_SPELL_51				= "激活";			--XD回蓝技
	RAL_TEXT_SPELL_52				= "灵魂链接图腾";	--SM群体减伤
	RAL_TEXT_SPELL_53				= "守护之魂";		--MS单体+
	RAL_TEXT_SPELL_54				= "远古列王守卫";	--FQ：单体减伤50%12秒
	...
	RAL_TEXT_BUFF_11				= "妖术";		--中了变形魔法的DEBUFF名称
	...
	RAL_TEXT_XML_47					= "致命一击";
	RAL_TEXT_XML_48					= "通报导致队友或Boss死亡的致命一击记录";
--	RAL_TEXT_XML_49					= "Boss战通报是谁进行了最后一击";
...
--	RAL_TEXT_XML_56					= "5人小队时通报自己死亡";
	...
	RAL_TEXT_XML_103				= "战斗复活";
	RAL_TEXT_XML_104				= "通报战斗复活技能";
	RAL_TEXT_XML_104_1				= "术士：灵魂石复活\n德鲁伊：复生\n死亡骑士：复活盟友";
	RAL_TEXT_XML_105				= "光明之泉";
	RAL_TEXT_XML_106				= "牧师施放光明之泉时进行通告";
