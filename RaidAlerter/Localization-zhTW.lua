...
--	RAL_TEXT_FUNC_10				= "通報戰士的破釜沉舟技能";
	...
	RAL_TEXT_FUNC_46				= "插件記憶體清理完畢，釋放了%sK內存";
...
--	RAL_TEXT_ALERT_22				= "**已啟動%s：%s"..RAL_TEXT_ARROW_R.."%s！**";
	...
	RAL_TEXT_SPELL_38				= "保護聖禦";		--QS單體減傷
	RAL_TEXT_SPELL_39				= "犧牲聖禦";		--QS單體減傷
	RAL_TEXT_SPELL_40				= "忠誠防衛者";		--QS加強版聖佑術
	RAL_TEXT_SPELL_41				= "神性守護";		--QS群體減傷
	RAL_TEXT_SPELL_42				= "真言術:壁";		--MS群體減傷
	RAL_TEXT_SPELL_43				= "痛苦鎮壓";		--MS單體減傷
	RAL_TEXT_SPELL_44				= "振奮咆哮";		--ZS群體破釜
	RAL_TEXT_SPELL_45				= "聖療術";			--QS單體大+
	RAL_TEXT_SPELL_46				= "狂暴恢復";		--熊T版破釜
	RAL_TEXT_SPELL_47				= "樹皮術";			--XD本體減傷
	RAL_TEXT_SPELL_48				= "復生";			--XD戰復
	RAL_TEXT_SPELL_49				= "盟友復生";		--DK戰復
	RAL_TEXT_SPELL_50				= "注入能量";		--戒牧加強技
	RAL_TEXT_SPELL_51				= "啟動";			--XD回藍技
	RAL_TEXT_SPELL_52				= "靈魂連結圖騰";	--SM群體減傷
	RAL_TEXT_SPELL_53				= "守護聖靈";		--MS單體+
	RAL_TEXT_SPELL_54				= "遠古諸王守護者";	--FQ：单体减伤50%12秒
	...
	RAL_TEXT_BUFF_11				= "妖術";		--中了變形魔法的DEBUFF名稱
	...
	RAL_TEXT_XML_47					= "致命一擊";
	RAL_TEXT_XML_48					= "通報導致隊友或Boss死亡的致命一擊記錄";
--	RAL_TEXT_XML_49					= "Boss戰通報是誰進行了最後一擊";
...
--	RAL_TEXT_XML_56					= "5人小隊時通報自己死亡";
	...
	RAL_TEXT_XML_103				= "戰斗復活";
	RAL_TEXT_XML_104				= "通報戰斗復活技能";
	RAL_TEXT_XML_104_1				= "術士：靈魂石復活\n德魯伊：復生\n死亡騎士：盟友復生";
	RAL_TEXT_XML_105				= "光束泉";
	RAL_TEXT_XML_106				= "牧師施放光束泉時進行通告";
