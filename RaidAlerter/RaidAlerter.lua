...
RaidAlerter_SYNC_VerPOINT = 29;
RaidAlerter_SYNC_MyStatus = "FFFFFFF";
RaidAlerter_SYNC_MyStatus_Last = "TTTTTTT";

RAL_BlzTanks = {};
RAL_Tanks = {};
RAL_COMBAT_LOG_DMG_CACHE = {};
RAL_COMBAT_LOG_DMG_CACHE_LIMIT = 200;
RAL_MEMBERS_GUID = {}

--Debug
RAL_UIMSG_TIMELIMIT = 0.5;
RAL_DEBUG = false;
...
RaidAlerter_SOUND_DATA = {
	[1]	= "Sound\\Doodad\\BellTollNightElf.wav",
	[2]	= "Sound\\interface\\AuctionWindowOpen.wav",
	[3]	= "Sound\\Doodad\\BellTollAlliance.wav",
	[4]	= "Sound\\Spells\\SeepingGaseous_Fel_Nova.wav",
	[5]	= "Sound\\Spells\\PVPFlagTaken.wav",
};
...
--更新选项菜单
	if (RaidAlerter_MainFrame:IsVisible()) then
		if RaidAlerter_SET.OnOff then RaidAlerterCheckLabel03_1:SetChecked(1) else RaidAlerterCheckLabel03_1:SetChecked(0) end
		if RaidAlerter_SET.Party_Alerter then RaidAlerterCheckLabel03_2:SetChecked(1) else RaidAlerterCheckLabel03_2:SetChecked(0) end
		if RaidAlerter_SET.OnlySelfCHAN then RaidAlerterCheckLabel03_3:SetChecked(1) else RaidAlerterCheckLabel03_3:SetChecked(0) end
		if RaidAlerter_SET.OnlySelfSCR then RaidAlerterCheckLabel03_4:SetChecked(1) else RaidAlerterCheckLabel03_4:SetChecked(0) end
		if RaidAlerter_SET.SoundAlert then RaidAlerterCheckLabel03_5:SetChecked(1) else RaidAlerterCheckLabel03_5:SetChecked(0) end
		if RaidAlerter_SET.ScrMsg then RaidAlerterCheckLabel03_6:SetChecked(1) else RaidAlerterCheckLabel03_6:SetChecked(0) end
		if RaidAlerter_SET.THREATCheck then RaidAlerterCheckLabel03_7:SetChecked(1) else RaidAlerterCheckLabel03_7:SetChecked(0) end
		if RaidAlerter_SET.ToTCheck then RaidAlerterCheckLabel03_8:SetChecked(1) else RaidAlerterCheckLabel03_8:SetChecked(0) end
		if RaidAlerter_SET.SpellIDAndCaster then RaidAlerterCheckLabel03_9:SetChecked(1) else RaidAlerterCheckLabel03_9:SetChecked(0) end
		if RaidAlerter_SET.MAXRAM then RaidAlerterCheckLabel04_1:SetValue(RaidAlerter_SET.MAXRAM); end
		if RaidAlerter_SET.TextMShow_OnOff then RaidAlerterCheckLabel05_1:SetChecked(1) else RaidAlerterCheckLabel05_1:SetChecked(0) end
		if RaidAlerter_SET.AF_Scale then RaidAlerterCheckLabel05_2:SetValue(RaidAlerter_SET.AF_Scale); end
		if RaidAlerter_SET.BossHealthPecentOnOff then RaidAlerterCheckLabel06_1:SetChecked(1) else RaidAlerterCheckLabel06_1:SetChecked(0) end
		if RaidAlerter_SET.BossHealthPecent then RaidAlerterCheckLabel06_2:SetValue(RaidAlerter_SET.BossHealthPecent); end
		if RaidAlerter_SET.BossKill then RaidAlerterCheckLabel06_3:SetChecked(1) else RaidAlerterCheckLabel06_3:SetChecked(0) end
		if RaidAlerter_SET.TANK_DangerHealth then RaidAlerterCheckLabel07_1:SetChecked(1) else RaidAlerterCheckLabel07_1:SetChecked(0) end
		...
		if RaidAlerter_SET.TANK_Death then RaidAlerterCheckLabel07_3:SetChecked(1) else RaidAlerterCheckLabel07_3:SetChecked(0) end
		if RaidAlerter_SET.TANK_ShieldWall then RaidAlerterCheckLabel08_1:SetChecked(1) else RaidAlerterCheckLabel08_1:SetChecked(0) end
		if RaidAlerter_SET.TANK_LastStand then RaidAlerterCheckLabel09_1:SetChecked(1) else RaidAlerterCheckLabel09_1:SetChecked(0) end
		if RaidAlerter_SET.TANK_ShieldReflection then RaidAlerterCheckLabel10_1:SetChecked(1) else RaidAlerterCheckLabel10_1:SetChecked(0) end
		...
		if RaidAlerter_SET.RES_DispelMagic then RaidAlerterCheckLabel11_2:SetChecked(1) else RaidAlerterCheckLabel11_2:SetChecked(0) end
		if RaidAlerter_SET.RES_Polymorph then RaidAlerterCheckLabel12_2:SetChecked(1) else RaidAlerterCheckLabel12_2:SetChecked(0) end
		if RaidAlerter_SET.RES_MagicBreak then RaidAlerterCheckLabel13_2:SetChecked(1) else RaidAlerterCheckLabel13_2:SetChecked(0) end
		if RaidAlerter_SET.RES_BuffStolen then RaidAlerterCheckLabel14_2:SetChecked(1) else RaidAlerterCheckLabel14_2:SetChecked(0) end
		if RaidAlerter_SET.Check_Poly then RaidAlerterCheckLabel08_3:SetChecked(1) else RaidAlerterCheckLabel08_3:SetChecked(0) end
		if RaidAlerter_SET.PolyDispel then RaidAlerterCheckLabel09_3:SetChecked(1) else RaidAlerterCheckLabel09_3:SetChecked(0) end
		if RaidAlerter_SET.Break_Poly then RaidAlerterCheckLabel10_3:SetChecked(1) else RaidAlerterCheckLabel10_3:SetChecked(0) end
		...
		if RaidAlerter_SET.SpellSummon then RaidAlerterCheckLabel08_4:SetChecked(1) else RaidAlerterCheckLabel08_4:SetChecked(0) end
...
function RaidAlerter_SET_FUNC_SpellSummon(checked)
	if checked == 1 then
		RaidAlerter_SET.SpellSummon = true;
	elseif checked =="OnOff" then
		RaidAlerter_SET.SpellSummon = not RaidAlerter_SET.SpellSummon;
	else
		RaidAlerter_SET.SpellSummon = false;
	end
	RaidAlerter.AddMsg(RAL_TEXT_FUNC_37..RaidAlerter_GetTFVarText(RaidAlerter_SET.SpellSummon));
	RaidAlerter_Option_MainFrame_Update();
end
...
function RaidAlerter_SET_FUNC_ResetRAM(arg)
	...
	if arg=="reset" then
		...
		RaidAlerter.AddMsg(string.format(RAL_TEXT_FUNC_46, RAL.ToGreen(OldRAM-gcinfo())));
	else
...
function RaidAlerter_SET_FUNC_MsgTest()
	...
	local AlertMsg = {
		...
		[2]	= {
			["Raid"]=string.format(RAL_TEXT_ALERT_30,PN,RaidAlerter_RAIDICON[8]..RAL_TEXT_UINTNAME_3,RAL.SpellIdToText(79105,1)),
			["Scr"]=string.format(RAL_TEXT_ALERT_30,RAL.ToPink(RAL_TEXT_YOU),RaidAlerter_RAIDICON[8]..RAL.ToRed(RAL_TEXT_UINTNAME_3),RAL.ToCyan(RAL.SpellIdToText(79105,0,1))),
			},
		[3]	= {
		...
		[6]	= {
			["Raid"]=string.format(RAL_TEXT_ALERT_34,PN..RAL.SpellIdToText(2139, 1),RaidAlerter_RAIDICON[8]..RAL_TEXT_UINTNAME_3,RAL.SpellIdToText(13323,1)),
			["Scr"]=string.format(RAL_TEXT_ALERT_34,RAL.ToPink(RAL_TEXT_YOU)..RAL.SpellIdToText(2139, 1, 1),RaidAlerter_RAIDICON[8]..RAL.ToRed(RAL_TEXT_UINTNAME_3),RAL.ToCyan(RAL.SpellIdToText(13323,0,1))),
			},
	};
	local ToTMsg = {
...
function RaidAlerter_SET_FUNC_ResetToDefaut(arg)
	...
	RaidAlerter_SET.MAXRAM = 460;
	RaidAlerter.AddMsg(string.format(RAL_TEXT_FUNC_47,"|cFF44FF44"..RaidAlerter_SET.MAXRAM));
	RaidAlerter_SET.TANK_DangerHealthPecent = 30;
	RaidAlerter_SET.BossHealthPecent = 10;
	RaidAlerter_SET_FUNC_OnOff(1);
	RaidAlerter_SET_FUNC_Party_Alerter(1);
	RaidAlerter_SET_FUNC_OnlySelfCHAN(0);
	RaidAlerter_SET_FUNC_OnlySelfSCR(0);
	RaidAlerter_SET_FUNC_SoundAlert(1);
	RaidAlerter_SET_FUNC_TextMShow_OnOff(1);
	RaidAlerter_SET_FUNC_BossHealthPecentOnOff(1);
	RaidAlerter_SET_FUNC_BossHealthPecent(10);
	RaidAlerter_SET_FUNC_BossKill(1);
	RaidAlerter_SET_FUNC_TANK_DangerHealth(1);
	RaidAlerter_SET_FUNC_TANK_DangerHealthPecent(30);
	RaidAlerter_SET_FUNC_TANK_Death(1);
	RaidAlerter_SET_FUNC_TANK_ShieldWall(1);
	RaidAlerter_SET_FUNC_TANK_LastStand(1);
	RaidAlerter_SET_FUNC_TANK_ShieldReflection(1);
	RaidAlerter_SET_FUNC_ScrMsg(1);
	RaidAlerter_SET_FUNC_THREATCheck(1);
	RaidAlerter_SET_FUNC_ToTCheck(1);
	RaidAlerter_SET_FUNC_OT_OnOff(1);
	RaidAlerter_SET_FUNC_OTM_OnOff(0);
	RaidAlerter_SET_FUNC_OTMShow_OnOff(0);
	RaidAlerter_SET_FUNC_Hunter_Mark(0);
	RaidAlerter_SET_FUNC_Hunter_Misdirection(1);
	RaidAlerter_SET_FUNC_Hunter_Shot(1);
	RaidAlerter_SET_FUNC_TANK_Taunt(1);
	RaidAlerter_SET_FUNC_RES_DispelMagic(1);
	RaidAlerter_SET_FUNC_RES_Polymorph(1);
	RaidAlerter_SET_FUNC_RES_MagicBreak(1);
	RaidAlerter_SET_FUNC_RES_BuffStolen(1);
	RaidAlerter_SET_FUNC_Check_Poly(1);
	RaidAlerter_SET_FUNC_PolyDispel(1);
	RaidAlerter_SET_FUNC_Break_Poly(1);
	RaidAlerter_SET_FUNC_Dispel_Magic(1);
	RaidAlerter_SET_FUNC_BuffStolen(1);
	RaidAlerter_SET_FUNC_Break_Magic(1);
	RaidAlerter_SET_FUNC_Check_Gem(1);
	RaidAlerter_SET_FUNC_SpellSummon(1);
	RaidAlerter_SET_FUNC_Check_Death_AtCombatEnd(1);
	RaidAlerter_SET_FUNC_Nef_PriestDown(0);
...
function RaidAlerter_MainFrame_SetAllChecked()
	...
	RaidAlerter_SET_FUNC_ToTCheck(1);
	RaidAlerter_SET_FUNC_OT_OnOff(1);
	RaidAlerter_SET_FUNC_OTM_OnOff(1);
	RaidAlerter_SET_FUNC_OTMShow_OnOff(1);
	RaidAlerter_SET_FUNC_Hunter_Mark(1);
	RaidAlerter_SET_FUNC_Hunter_Misdirection(1);
	RaidAlerter_SET_FUNC_Hunter_Shot(1);
	RaidAlerter_SET_FUNC_TANK_Taunt(1);
	RaidAlerter_SET_FUNC_RES_DispelMagic(1);
	...
	RaidAlerter_SET_FUNC_SpellSummon(1);
	RaidAlerter_SET_FUNC_Check_Death_AtCombatEnd(1);
	RaidAlerter_SET_FUNC_Nef_PriestDown(1);
...
--	RaidAlerter_SET_FUNC_Party_Alerter(0);
	RaidAlerter_SET_FUNC_OnlySelfCHAN(0);
	RaidAlerter_SET_FUNC_OnlySelfSCR(0);
	RaidAlerter_SET_FUNC_SoundAlert(0);
	RaidAlerter_SET_FUNC_BossHealthPecentOnOff(0);
	RaidAlerter_SET_FUNC_BossKill(0);
	RaidAlerter_SET_FUNC_TANK_DangerHealth(0);
	RaidAlerter_SET_FUNC_TANK_Death(0);
	RaidAlerter_SET_FUNC_TANK_ShieldWall(0);
	RaidAlerter_SET_FUNC_TANK_LastStand(0);
	RaidAlerter_SET_FUNC_TANK_ShieldReflection(0);
	RaidAlerter_SET_FUNC_ScrMsg(0);
	RaidAlerter_SET_FUNC_THREATCheck(0);
	RaidAlerter_SET_FUNC_ToTCheck(0);
	RaidAlerter_SET_FUNC_OT_OnOff(0);
	RaidAlerter_SET_FUNC_OTM_OnOff(0);
	RaidAlerter_SET_FUNC_OTMShow_OnOff(0);
	RaidAlerter_SET_FUNC_Hunter_Mark(0);
	RaidAlerter_SET_FUNC_Hunter_Misdirection(0);
	RaidAlerter_SET_FUNC_Hunter_Shot(0);
	RaidAlerter_SET_FUNC_TANK_Taunt(0);
	RaidAlerter_SET_FUNC_RES_DispelMagic(0);
	RaidAlerter_SET_FUNC_RES_Polymorph(0);
	RaidAlerter_SET_FUNC_RES_MagicBreak(0);
	RaidAlerter_SET_FUNC_RES_BuffStolen(0);
	RaidAlerter_SET_FUNC_Check_Poly(0);
	RaidAlerter_SET_FUNC_PolyDispel(0);
	RaidAlerter_SET_FUNC_Break_Poly(0);
	RaidAlerter_SET_FUNC_Dispel_Magic(0);
	RaidAlerter_SET_FUNC_BuffStolen(0);
	RaidAlerter_SET_FUNC_Break_Magic();
	RaidAlerter_SET_FUNC_Check_Gem(0);
	RaidAlerter_SET_FUNC_SpellSummon(0);
	RaidAlerter_SET_FUNC_Check_Death_AtCombatEnd(0);
	RaidAlerter_SET_FUNC_Nef_PriestDown(0);
	RaidAlerter_SET_FUNC_Nef_TANKPoly(0);
	RaidAlerter_SET_FUNC_TAQ_Twin_AOEAdd(0);
...
function RaidAlerter_Check_Variables()
	...
	if RaidAlerter_SET.MAXRAM == nil then RaidAlerter_SET.MAXRAM = 460; end
	...
	if RaidAlerter_SET.SpellSummon == nil then RaidAlerter_SET.SpellSummon = true; end
...
function RaidAlerter_CheckPlayer(check)
	...
	elseif GetNumPartyMembers() > 0 then
		...
		local i;
		local unit = "";
		local PartyNum = GetNumPartyMembers() + 1;
...
--4.1后王者祝福检查记录合并至野性
--		[RAL_TEXT_BUFF_12] = {
--			[RAL_TEXT_DRUID]		= {["name"]="",["count"]=0,},
--			[RAL_TEXT_HUNTER]		= {["name"]="",["count"]=0,},
--			[RAL_TEXT_MAGE]			= {["name"]="",["count"]=0,},
--			[RAL_TEXT_PRIEST]		= {["name"]="",["count"]=0,},
--			[RAL_TEXT_ROGUE]		= {["name"]="",["count"]=0,},
--			[RAL_TEXT_WARLOCK]		= {["name"]="",["count"]=0,},
--			[RAL_TEXT_WARRIOR]		= {["name"]="",["count"]=0,},
--			[RAL_TEXT_SHAMAN]		= {["name"]="",["count"]=0,},
--			[RAL_TEXT_PALADIN]		= {["name"]="",["count"]=0,},
...
--			},
	...
	local HasPALADIN_12 = false;
	local HasPALADIN_14 = false;
	...
	for i = 1,GetNumRaidMembers() do
		...
		if online then
			if subgroup <= RaidAlerter_SET.RAIDMODE_MAX_GROUP then
				...
				if class == RAL_TEXT_WARLOCK then CLASS_COUNT[6] = CLASS_COUNT[6] + 1; end
				if class == RAL_TEXT_WARRIOR then CLASS_COUNT[7] = CLASS_COUNT[7] + 1; end
				if class == RAL_TEXT_SHAMAN then CLASS_COUNT[8] = CLASS_COUNT[8] + 1; end
				if class == RAL_TEXT_PALADIN then
					CLASS_COUNT[9] = CLASS_COUNT[9] + 1;
					if UnitHealthMax("raid"..i) > (RaidHPMAXAVG*1.25) then
						HasFQ = true;			--高血量判定为FQ
					end
				end
				if class == RAL_TEXT_DEATHKNIGHT then CLASS_COUNT[10] = CLASS_COUNT[10] + 1; end
	...
	if CLASS_COUNT[9] >= 2 then HasPALADIN_16 = true;HasPALADIN_18 = true; end		--2QS增加智慧、力量祝福检查（4.0后仅检查力量祝福）
	if CLASS_COUNT[9] >= 4 and HasFQ then HasPALADIN_14 = true; end					--4QS且有FQ时增加庇护祝福检查（4.0后忽略）
...
--			local HasPRIEST_BUFF_2 = false;		--精神
			...
			local HasPALADIN_BUFF_14 = false;
			local HasPALADIN_BUFF_16 = false;
...
--				HasPRIEST_BUFF_2 = true;
			...
			while UnitBuff(unit, j) do
				...
				if string.find(BuffTEXT, RAL_TEXT_BUFF_4) or string.find(BuffTEXT, RAL_TEXT_BUFF_5) then
					HasPRIEST_BUFF_1 = true;
				end
--				if string.find(BuffTEXT, RAL_TEXT_BUFF_22) or string.find(BuffTEXT, RAL_TEXT_BUFF_23) then
--					HasPRIEST_BUFF_2 = true;
--				end
				if string.find(BuffTEXT, RAL_TEXT_BUFF_6) or string.find(BuffTEXT, RAL_TEXT_BUFF_7) or string.find(BuffTEXT, RAL_TEXT_BUFF_7_SPEC_1) or string.find(BuffTEXT, RAL_TEXT_BUFF_7_SPEC_2) then
					HasMAGE_BUFF = true;
				end
				if string.find(BuffTEXT, RAL_TEXT_BUFF_8) or string.find(BuffTEXT, RAL_TEXT_BUFF_9) then
					HasDRUID_BUFF = true;
				end
				if string.find(BuffTEXT, RAL_TEXT_BUFF_12) or string.find(BuffTEXT, RAL_TEXT_BUFF_13)
				or string.find(BuffTEXT, RAL_TEXT_BUFF_13_SPEC_1) then
					HasPALADIN_BUFF_12 = true;
				end
				if string.find(BuffTEXT, RAL_TEXT_BUFF_14) or string.find(BuffTEXT, RAL_TEXT_BUFF_15) then
					HasPALADIN_BUFF_14 = true;
				end
				if string.find(BuffTEXT, RAL_TEXT_BUFF_16) or string.find(BuffTEXT, RAL_TEXT_BUFF_17) or string.find(BuffTEXT, RAL_TEXT_BUFF_17_SPEC_1) then
					HasPALADIN_BUFF_16 = true;
				end
				if string.find(BuffTEXT, RAL_TEXT_BUFF_18) or string.find(BuffTEXT, RAL_TEXT_BUFF_19) or string.find(BuffTEXT, RAL_TEXT_BUFF_19_SPEC_1) then
					HasPALADIN_BUFF_18 = true;
				end
...
--				end
				...
				--忽略野德的智力和智慧（猎豹和熊状态/HP>MP则判定为野德）
					...
					or (UnitHealthMax(unit) > (UnitPowerMax(unit)*2.2)) then
						HasMAGE_BUFF = true;
						HasPALADIN_BUFF_16 = true;
						IsYD = true;
					end
				...
				--忽略增强萨满的智慧（HP>>MP）
					if UnitHealthMax(unit) > (UnitPowerMax(unit)*2.2) then
						HasPALADIN_BUFF_16 = true;
						IsZQSM = true;
					end
				end
...
--				and HasPALADIN_BUFF_16 and HasPALADIN_BUFF_18 and ((IsFQ and HasFQBuff) or (not IsFQ))) then j = 99; end
			...
			if (not HasPRIEST_BUFF_1) and HasPRIEST then
				Group_NoBuff_Name[RAL_TEXT_BUFF_4][subgroup]["name"] = Group_NoBuff_Name[RAL_TEXT_BUFF_4][subgroup]["name"]..name..".";
				Group_NoBuff_Name[RAL_TEXT_BUFF_4][subgroup]["count"] = Group_NoBuff_Name[RAL_TEXT_BUFF_4][subgroup]["count"] + 1;
				NoBuffCount = NoBuffCount + 1;
			end
--			if (not HasPRIEST_BUFF_2) and HasPRIEST then
--				Group_NoBuff_Name[RAL_TEXT_BUFF_22][subgroup]["name"] = Group_NoBuff_Name[RAL_TEXT_BUFF_22][subgroup]["name"]..name..".";
--				Group_NoBuff_Name[RAL_TEXT_BUFF_22][subgroup]["count"] = Group_NoBuff_Name[RAL_TEXT_BUFF_22][subgroup]["count"] + 1;
--				NoBuffCount = NoBuffCount + 1;
--			end
			if (not HasMAGE_BUFF) and HasMAGE then
				Group_NoBuff_Name[RAL_TEXT_BUFF_6][subgroup]["name"] = Group_NoBuff_Name[RAL_TEXT_BUFF_6][subgroup]["name"]..name..".";
				Group_NoBuff_Name[RAL_TEXT_BUFF_6][subgroup]["count"] = Group_NoBuff_Name[RAL_TEXT_BUFF_6][subgroup]["count"] + 1;
				NoBuffCount = NoBuffCount + 1;
			end
--			if (not HasDRUID_BUFF) and HasDRUID then
			--4.1后：XD野性和QS王者合并
			if (not(HasDRUID_BUFF or HasPALADIN_BUFF_12)) and (HasDRUID or HasPALADIN_12) then
				Group_NoBuff_Name[RAL_TEXT_BUFF_8][subgroup]["name"] = Group_NoBuff_Name[RAL_TEXT_BUFF_8][subgroup]["name"]..name..".";
				Group_NoBuff_Name[RAL_TEXT_BUFF_8][subgroup]["count"] = Group_NoBuff_Name[RAL_TEXT_BUFF_8][subgroup]["count"] + 1;
				NoBuffCount = NoBuffCount + 1;
			end
--			if (not HasPALADIN_BUFF_12) and HasPALADIN_12 then
--				Group_NoBuff_Name[RAL_TEXT_BUFF_12][class]["name"] = Group_NoBuff_Name[RAL_TEXT_BUFF_12][class]["name"]..name..".";
--				Group_NoBuff_Name[RAL_TEXT_BUFF_12][class]["count"] = Group_NoBuff_Name[RAL_TEXT_BUFF_12][class]["count"] + 1;
--				NoBuffCount = NoBuffCount + 1;
--			end
			if (not HasPALADIN_BUFF_18) and HasPALADIN_18 then
				--4.0.3后检查所有职业的力量祝福（智慧祝福已合并到力量祝福）
	...
	if NoBuffCount == 0 then
		RAL.SendMSG(RAL_TEXT_CHECK_19,"RAID",1);
	else
		RAL.SendMSG(string.format(RAL_TEXT_CHECK_20,NoBuffCount),"RAID",1);
		local msg = "";
		if HasPRIEST then
			msg = "";
			for i = 1, RaidAlerter_SET.RAIDMODE_MAX_GROUP do
				if Group_NoBuff_Name[RAL_TEXT_BUFF_4][i]["name"] ~= "" then
					if Group_NoBuff_Name[RAL_TEXT_BUFF_4][i]["count"] >= GROUP_COUNT[i] then
						Group_NoBuff_Name[RAL_TEXT_BUFF_4][i]["name"] = RAL_TEXT_CHECK_21;
					end
					msg = msg..string.format(RAL_TEXT_CHECK_22,i,Group_NoBuff_Name[RAL_TEXT_BUFF_4][i]["name"]).." ";
				end
			end
			if msg ~= "" then
				msg = RAL_TEXT_CHECK_23..": "..msg;
				RAL.SendMSG(msg,"RAID",1);
			end
--			msg = "";
--			for i = 1, RaidAlerter_SET.RAIDMODE_MAX_GROUP do
--				if Group_NoBuff_Name[RAL_TEXT_BUFF_22][i]["name"] ~= "" then
--					if Group_NoBuff_Name[RAL_TEXT_BUFF_22][i]["count"] >= GROUP_COUNT[i] then
--						Group_NoBuff_Name[RAL_TEXT_BUFF_22][i]["name"] = RAL_TEXT_CHECK_21;
--					end
--					msg = msg..string.format(RAL_TEXT_CHECK_22,i,Group_NoBuff_Name[RAL_TEXT_BUFF_22][i]["name"]).." ";
--				end
--			end
--			if msg ~= "" then
--				msg = RAL_TEXT_BUFF_22..": "..msg;
--				RAL.SendMSG(msg,"RAID",1);
--			end
		end
		if HasMAGE then
			msg = "";
			for i = 1, RaidAlerter_SET.RAIDMODE_MAX_GROUP do
				if Group_NoBuff_Name[RAL_TEXT_BUFF_6][i]["name"] ~= "" then
					if Group_NoBuff_Name[RAL_TEXT_BUFF_6][i]["count"] >= GROUP_COUNT[i] then
						Group_NoBuff_Name[RAL_TEXT_BUFF_6][i]["name"] = RAL_TEXT_CHECK_21;
					end
					msg = msg..string.format(RAL_TEXT_CHECK_22,i,Group_NoBuff_Name[RAL_TEXT_BUFF_6][i]["name"]).." ";
				end
			end
			if msg ~= "" then
				msg = RAL_TEXT_BUFF_7..": "..msg;
				RAL.SendMSG(msg,"RAID",1);
			end
		end
		if (HasDRUID or HasPALADIN_12) then
			msg = "";
			for i = 1, RaidAlerter_SET.RAIDMODE_MAX_GROUP do
				if Group_NoBuff_Name[RAL_TEXT_BUFF_8][i]["name"] ~= "" then
					if Group_NoBuff_Name[RAL_TEXT_BUFF_8][i]["count"] >= GROUP_COUNT[i] then
						Group_NoBuff_Name[RAL_TEXT_BUFF_8][i]["name"] = RAL_TEXT_CHECK_21;
					end
					msg = msg..string.format(RAL_TEXT_CHECK_22,i,Group_NoBuff_Name[RAL_TEXT_BUFF_8][i]["name"]).." ";
				end
			end
			if msg ~= "" then
--				msg = RAL_TEXT_BUFF_9..": "..msg;
				msg = RAL_TEXT_BUFF_9.."/"..RAL_TEXT_BUFF_12..": "..msg;
				RAL.SendMSG(msg,"RAID",1);
			end
		end
--		if HasPALADIN_12 then
--			msg = "";
--			for i = 1, 10 do
--				if Group_NoBuff_Name[RAL_TEXT_BUFF_12][CLASS_INDEX[i]]["name"] ~= "" then
--					if Group_NoBuff_Name[RAL_TEXT_BUFF_12][CLASS_INDEX[i]]["count"] >= CLASS_COUNT[i] then
--						Group_NoBuff_Name[RAL_TEXT_BUFF_12][CLASS_INDEX[i]]["name"] = RAL_TEXT_CHECK_21;
--					end
--					msg = msg..string.format("%s(%s)",CLASS_INDEX[i],Group_NoBuff_Name[RAL_TEXT_BUFF_12][CLASS_INDEX[i]]["name"]).." ";
--				end
--			end
--			if msg ~= "" then
--				msg = RAL_TEXT_BUFF_12..": "..msg;
--				RAL.SendMSG(msg,"RAID",1);
--			end
--		end
		if HasPALADIN_14 then
			msg = "";
			for i = 1, 10 do
				if Group_NoBuff_Name[RAL_TEXT_BUFF_14][CLASS_INDEX[i]]["name"] ~= "" then
					if Group_NoBuff_Name[RAL_TEXT_BUFF_14][CLASS_INDEX[i]]["count"] >= CLASS_COUNT[i] then
						Group_NoBuff_Name[RAL_TEXT_BUFF_14][CLASS_INDEX[i]]["name"] = RAL_TEXT_CHECK_21;
					end
					msg = msg..string.format("%s(%s)",CLASS_INDEX[i],Group_NoBuff_Name[RAL_TEXT_BUFF_14][CLASS_INDEX[i]]["name"]).." ";
				end
			end
			if msg ~= "" then
				msg = RAL_TEXT_BUFF_14..": "..msg;
				RAL.SendMSG(msg,"RAID",1);
			end
		end
		if HasPALADIN_16 then
			msg = "";
			for i = 1, 10 do
				if Group_NoBuff_Name[RAL_TEXT_BUFF_16][CLASS_INDEX[i]]["name"] ~= "" then
					if Group_NoBuff_Name[RAL_TEXT_BUFF_16][CLASS_INDEX[i]]["count"] >= CLASS_COUNT[i] then
						Group_NoBuff_Name[RAL_TEXT_BUFF_16][CLASS_INDEX[i]]["name"] = RAL_TEXT_CHECK_21;
					end
					msg = msg..string.format("%s(%s)",CLASS_INDEX[i],Group_NoBuff_Name[RAL_TEXT_BUFF_16][CLASS_INDEX[i]]["name"]).." ";
				end
			end
			if msg ~= "" then
				msg = RAL_TEXT_BUFF_16..": "..msg;
				RAL.SendMSG(msg,"RAID",1);
			end
		end
		if HasPALADIN_18 then
			msg = "";
			for i = 1, 10 do
				if Group_NoBuff_Name[RAL_TEXT_BUFF_18][CLASS_INDEX[i]]["name"] ~= "" then
					if Group_NoBuff_Name[RAL_TEXT_BUFF_18][CLASS_INDEX[i]]["count"] >= CLASS_COUNT[i] then
						Group_NoBuff_Name[RAL_TEXT_BUFF_18][CLASS_INDEX[i]]["name"] = RAL_TEXT_CHECK_21;
					end
					msg = msg..string.format("%s(%s)",CLASS_INDEX[i],Group_NoBuff_Name[RAL_TEXT_BUFF_18][CLASS_INDEX[i]]["name"]).." ";
				end
			end
			if msg ~= "" then
				msg = RAL_TEXT_BUFF_18..": "..msg;
				RAL.SendMSG(msg,"RAID",1);
			end
		end
...
function RaidAlerter_Target_Check(check)
	...
	if string.upper(check) == "MT" then
		...
		RAL.SendMSG(string.format(RAL_TEXT_CHECK_28,check),"RAID",1);
		...
		for i = 1, 5 do
			if (RAL_Tanks[i]) then
				...
				if (unit) then
					...
					RAL.SendMSG(string.format(RAL_TEXT_CHECK_30,MSG_NAME,MSG_ICON,MSG_TARNAME),"RAID",1);
				end
			end
		end
	else
...
function RaidAlerter_CheckGem(check)
	...
	RAL.SendMSG(string.format(RAL_TEXT_TIP_6,#GemName)..": "..RaidAlerter_GetGemOnNames(),"RAID",1);
end
...
function RaidAlerter_OnEvent(self, event, ...)
	if event == "ADDON_LOADED" then
		...
		RegisterAddonMessagePrefix("RAL_CHECKVER");
		RegisterAddonMessagePrefix("RAL_SELECT");
		RegisterAddonMessagePrefix("RAL_SELECTREPLY");
		RegisterAddonMessagePrefix("RAL_CHECKVERREPL");
	...
	elseif event == "PLAYER_REGEN_ENABLED" then
		MyLastThreatState = 0;
		TarTarISME = false;
	elseif event == "RAID_ROSTER_UPDATE" or event == "PARTY_MEMBERS_CHANGED" or event == "UNIT_PHASE" then
		RaidAlerter_ReBuild_MEMBERS();
		RosterChanged = true;
...
function RaidAlerter_ReBuild_MEMBERS()
	RAL_MEMBERS_GUID = {};
	local unit = "";
	if UnitInRaid("player") then
		for i=1, GetNumRaidMembers() do
			unit = "raid"..i;
			RAL_MEMBERS_GUID[UnitGUID(unit)] = {name=UnitName(unit), unitid=unit};
		end
	elseif GetNumPartyMembers() > 0 then
		for i=0, GetNumPartyMembers() do
			if i == 0 then
...
function RaidAlerter_CombatLogEvent(self, ...)
	if RaidAlerter_SET.OnOff then
		timestamp, eventtype, _, srcGUID, srcName, srcFlags, _, dstGUID, dstName, dstFlags, _, spellId, spellName, spellSchool, auraType, amount = ...;
		if eventtype == "SPELL_DAMAGE" or eventtype == "SPELL_PERIODIC_DAMAGE" or eventtype == "RANGE_DAMAGE" or eventtype == "SWING_DAMAGE" or eventtype == "ENVIRONMENTAL_DAMAGE" then
			RaidAlerter_COMBAT_LOG_DMG_Record();
		end
		RaidAlerter_Raid_PARTY_Combat_Alerter();
	end
end

function RaidAlerter_COMBAT_LOG_DMG_Record()
	local dmg = 0;
	...
	RAL_COMBAT_LOG_DMG_CACHE[dstGUID] = {notchecked=true, timestamp=GetTime(), eventtype=eventtype, srcName=srcName, dstName=dstName, spellId=spellId, dmg=dmg};
end

function RaidAlerter_GetDeathReason(dstGUID)
	local DRmsg = "UNKNOW";
	if not RAL_COMBAT_LOG_DMG_CACHE[dstGUID] then
		return DRmsg, -999;
	end
	local times = (GetTime()-RAL_COMBAT_LOG_DMG_CACHE[dstGUID].timestamp);
	if times < 3 and RAL_COMBAT_LOG_DMG_CACHE[dstGUID].notchecked then
		if RAL_COMBAT_LOG_DMG_CACHE[dstGUID].srcName == nil then
			if RAL_DEBUG then RaidAlerter.AddMsg(RAL_COMBAT_LOG_DMG_CACHE[dstGUID].dstName..":"..RAL_COMBAT_LOG_DMG_CACHE[dstGUID].eventtype..RAL.ToRed(" srcName = nil >> Fixed"));end		--debug
			RAL_COMBAT_LOG_DMG_CACHE[dstGUID].srcName = "";
		end
		if RAL_COMBAT_LOG_DMG_CACHE[dstGUID].eventtype == "SPELL_DAMAGE" then
			DRmsg = format("%s%s"..DAMAGE.."%s", RAL_COMBAT_LOG_DMG_CACHE[dstGUID].srcName, RAL.SpellIdToText(RAL_COMBAT_LOG_DMG_CACHE[dstGUID].spellId, 1), RAL_COMBAT_LOG_DMG_CACHE[dstGUID].dmg);
		elseif RAL_COMBAT_LOG_DMG_CACHE[dstGUID].eventtype == "SPELL_PERIODIC_DAMAGE" then
			DRmsg = format("%s%s"..DAMAGE.."%s", RAL_COMBAT_LOG_DMG_CACHE[dstGUID].srcName, RAL.SpellIdToText(RAL_COMBAT_LOG_DMG_CACHE[dstGUID].spellId, 1), RAL_COMBAT_LOG_DMG_CACHE[dstGUID].dmg);
		elseif RAL_COMBAT_LOG_DMG_CACHE[dstGUID].eventtype == "RANGE_DAMAGE" then
			DRmsg = format("%s%s"..DAMAGE.."%s", RAL_COMBAT_LOG_DMG_CACHE[dstGUID].srcName, RAL.SpellIdToText(RAL_COMBAT_LOG_DMG_CACHE[dstGUID].spellId, 1), RAL_COMBAT_LOG_DMG_CACHE[dstGUID].dmg);
		elseif RAL_COMBAT_LOG_DMG_CACHE[dstGUID].eventtype == "SWING_DAMAGE" then
			DRmsg = format("%s%s"..DAMAGE.."%s", RAL_COMBAT_LOG_DMG_CACHE[dstGUID].srcName, RAL_TEXT_SPELL_29, RAL_COMBAT_LOG_DMG_CACHE[dstGUID].dmg);
		elseif RAL_COMBAT_LOG_DMG_CACHE[dstGUID].eventtype == "ENVIRONMENTAL_DAMAGE" then
			DRmsg = format("%s%s"..DAMAGE.."%s", "", getglobal("ACTION_ENVIRONMENTAL_DAMAGE_"..RAL_COMBAT_LOG_DMG_CACHE[dstGUID].spellId), RAL_COMBAT_LOG_DMG_CACHE[dstGUID].dmg);
		end
	end
--	table.remove(RAL_COMBAT_LOG_DMG_CACHE, dstGUID);
	RAL_COMBAT_LOG_DMG_CACHE[dstGUID].notchecked = false;
	return DRmsg, times;
end
...
function RaidAlerter_SYNC(ARG_1,ARG_2,ARG_3,ARG_4)
	if ARG_1=="RAL_SELECT" then
		...
		if RaidAlerter_SET.SpellSummon then SETONCOUNT = SETONCOUNT + 0.5;end
		...
		local _,_,RAL_SYNC_latency_Local,RAL_SYNC_latency_World = GetNetStats();
		local RAL_SYNC_latency = (RAL_SYNC_latency_Local + RAL_SYNC_latency_World)/2;
	...
	if ARG_1=="RAL_CHECKVER" then
		local _,_,RAL_SYNC_latency_Local,RAL_SYNC_latency_World = GetNetStats();
		RaidAlerter_SetAddonMessage("RAL_CHECKVERREPL", RaidAlerter_Version.."("..RaidAlerter_GetTFVarText(RaidAlerter_SET.OnOff,1)..")  "..RAL_SYNC_latency_Local.."/"..RAL_SYNC_latency_World.."ms, "..format("%.1f",GetFramerate()).."FPS");
		return;
	end
...
function RaidAlerter_Frame_OnUpdate(self)
	if GetTime() > RAL_NextUpdateTime then
		...
		if (RaidAlerter_GetTimer("RaidAlerter_SYNC_MyStatus_Check")>9) and (RosterChanged) then
			...
			local PP3="";
			local PP4="";
			if UnitInRaid("player") then PR="T" else PR="F" end
			if (not UnitInRaid("player")) and (GetNumPartyMembers()>0) then PP="T" else PP="F" end
			if (IsRaidLeader() or IsRaidOfficer()) then PA="T" else PA="F" end
			if UnitExists("party1") and UnitInPhase("party1") then PP1="T" else PP1="F" end
			if UnitExists("party2") and UnitInPhase("party2") then PP2="T" else PP2="F" end
			if UnitExists("party3") and UnitInPhase("party3") then PP3="T" else PP3="F" end
			if UnitExists("party4") and UnitInPhase("party4") then PP4="T" else PP4="F" end
			RaidAlerter_SYNC_MyStatus = PR..PP..PA..PP1..PP2..PP3..PP4;
			if RaidAlerter_SYNC_MyStatus_Last ~= RaidAlerter_SYNC_MyStatus then
				...
				if RAL_DEBUG then RaidAlerter.AddSCRMsg("RAL_SELECT Start...",nil,1) end;		--debug
			end
		...
		if UnitInRaid("player") then
			...
			if RaidAlerter_RaidAllInCombat then
				...
				if (RaidAlerter_Alerter_System["lasticon"] ~= "0") then
					local LastIconUNIT = RaidAlerter_NameToUnit(RaidAlerter_Alerter_System["lasticon"]);
					if LastIconUNIT then
						SetRaidTargetIcon(LastIconUNIT, 0);
					end
				...
				--自动回收垃圾内存机制：RAID中若RaidAlerter内存占用超过设定界限（默认460K）则在战斗结束时予以回收
					...
					if (not UnitIsGhost("player")) then
						...
						if m == 0 then
							if RaidAlerter_Alerter_System.BossHealthPecentTMP < 99 then
								RAL.SendMSG(string.format(RAL_TEXT_ALERT_9,s),"RAID");
							else
								RaidAlerter.AddMsg("|cFF00FF00"..string.format(RAL_TEXT_ALERT_9,"|cFFFFFFFF"..s.."|cFF00FF00"));
							end
						else
							if RaidAlerter_Alerter_System.BossHealthPecentTMP < 99 then
								RAL.SendMSG(string.format(RAL_TEXT_ALERT_10,m,s),"RAID");
							else
			...
			--非RAID状态下，在非战斗状态时每200秒检测一次内存占用。若内存占用超过设定界限（默认460K）则启动清理
			...
			if GetNumPartyMembers()>0 then
				if RaidAlerter_SET.OnOff then
					if RaidAlerter_SYNC_SELECT_TOME == 1 then
						RaidAlerter_Attack_Frame_Text:SetText(string.format(RAL_TEXT_FRAME_2, "|cFF20FF20"..RAL_TEXT_FRAME_ON.."|r", RAL.ToOrange(GetNumPartyMembers()+1), RaidAlerter_GetCurrentDifficulty(2), RaidAlerter_LootMethodTEXT(2)));
					else
						RaidAlerter_Attack_Frame_Text:SetText(string.format(RAL_TEXT_FRAME_2, "|cFFFFDD00"..RAL_TEXT_FRAME_ON.."|r", RAL.ToOrange(GetNumPartyMembers()+1), RaidAlerter_GetCurrentDifficulty(2), RaidAlerter_LootMethodTEXT(2)));
					end
				else
					RaidAlerter_Attack_Frame_Text:SetText(string.format(RAL_TEXT_FRAME_2, "|cFFFF2020"..RAL_TEXT_FRAME_OFF.."|r", RAL.ToOrange(GetNumPartyMembers()+1), RaidAlerter_GetCurrentDifficulty(2), RaidAlerter_LootMethodTEXT(2)));
				end
...
function RaidAlerter_Attack_Frame_OnUpdate()
	if Attack_Frame_UPDATE_FREQ >= 2 then				--更新频率0.15x2=0.3秒
		...
		if IsInInstance() or RaidAlerter_RaidAllInCombat then
			...
			if RaidAlerter_SET.OnOff then
				if RaidAlerter_SYNC_SELECT_TOME == 1 then
					RaidAlerter_Attack_Frame_Text:SetText(string.format(RAL_TEXT_FRAME_4, "|cFF20FF20"..RAL_TEXT_FRAME_ON.."|r",RAL.ToOrange(GetNumRaidMembers()), RaidAlerter_GetCurrentDifficulty(1), RaidAlerter_LootMethodTEXT(2)));
				else
					RaidAlerter_Attack_Frame_Text:SetText(string.format(RAL_TEXT_FRAME_4, "|cFFFFDD00"..RAL_TEXT_FRAME_ON.."|r",RAL.ToOrange(GetNumRaidMembers()), RaidAlerter_GetCurrentDifficulty(1), RaidAlerter_LootMethodTEXT(2)));
				end
			else
				RaidAlerter_Attack_Frame_Text:SetText(string.format(RAL_TEXT_FRAME_4, "|cFFFF2020"..RAL_TEXT_FRAME_OFF.."|r",RAL.ToOrange(GetNumRaidMembers()), RaidAlerter_GetCurrentDifficulty(1), RaidAlerter_LootMethodTEXT(2)));
			end
		end
...
function RaidAlerter_Raid_PARTY_Combat_Alerter()
	...
	if eventtype == "UNIT_DIED" then
		if RaidAlerter_SET.BossKill then
			if dstGUID == CurBoss_GUID then
				local DeathReasonMSG, times = RaidAlerter_GetDeathReason(dstGUID);
				if RAL_DEBUG then RaidAlerter.AddMsg("Found MSG "..RAL.ToRed(format("%.4f", times)).."s ago.");end		--debug
				if DeathReasonMSG ~= "UNKNOW" then
					RAL.SendMSG(string.format(RAL_TEXT_ALERT_35, dstName, DeathReasonMSG), AlertChan);
				end
				return;
			end
			TempUnit1 = RaidAlerter_GUIDToUnit(dstGUID);
			if TempUnit1 then
				if not UnitIsFeignDeath(TempUnit1) then
					local DeathReasonMSG, times = RaidAlerter_GetDeathReason(dstGUID);
					if RAL_DEBUG then RaidAlerter.AddMsg("Found MSG "..RAL.ToRed(format("%.4f", times)).."s ago.");end		--debug
					if DeathReasonMSG ~= "UNKNOW" then
						RAL.SendMSG(string.format(RAL_TEXT_ALERT_45, dstName, DeathReasonMSG), AlertChan);
						if dstGUID == UnitGUID("player") then
							RaidAlerter.AddSCRMsg(string.format(RAL_TEXT_ALERT_45, RAL.ToPink(RAL_TEXT_YOU), RAL.ToRed(DeathReasonMSG)));
						end
					end
					return;
				end
	...
	if eventtype == "SPELL_AURA_APPLIED" or eventtype == "SPELL_RESURRECT" or eventtype == "SPELL_CAST_SUCCESS" then
		if spellName == RAL_TEXT_SPELL_3 or spellName == RAL_TEXT_SPELL_48 or spellName == RAL_TEXT_SPELL_49 then
			TempUnit1 = RaidAlerter_GUIDToUnit(dstGUID);
			if TempUnit1 then
				if RaidAlerter_SET.Check_Gem then
					RAL.SendMSG(string.format(RAL_TEXT_ALERT_44,RAL.SpellIdToText(spellId, 1),srcName,dstName), AlertWChan, 0, 1, "RELIFE"..srcGUID);	--刷屏限制：1秒
--					RaidAlerter.AddSCRMsg(string.format(RAL_TEXT_ALERT_44,RAL.SpellIdToText(spellId, 1, 1),RaidAlerter_ToClassColorNameText(srcName),RaidAlerter_ToClassColorNameText(dstName)));
				end
	...
	if eventtype == "SPELL_CAST_SUCCESS" then
		...
		if RaidAlerter_SET.TANK_ShieldWall then
			if spellName == RAL_TEXT_SPELL_1 or spellName == RAL_TEXT_SPELL_30 or spellName == RAL_TEXT_SPELL_31 or spellName == RAL_TEXT_SPELL_33
			or spellName == RAL_TEXT_SPELL_34 or spellName == RAL_TEXT_SPELL_40 or spellName == RAL_TEXT_SPELL_41 or spellName == RAL_TEXT_SPELL_47 or spellName == RAL_TEXT_SPELL_54 then
				TempUnit1 = RaidAlerter_GUIDToUnit(srcGUID);
				if TempUnit1 then
					if spellName == RAL_TEXT_SPELL_54 then		--远古列王守卫：只通报防骑坦
						if RaidAlerter_TestIsMtList(TempUnit1) then
							RAL.SendMSG(string.format(RAL_TEXT_ALERT_16,srcName,RAL.SpellIdToText(spellId, 1)), AlertWChan);
						end
						return;
					end
					RAL.SendMSG(string.format(RAL_TEXT_ALERT_16,srcName,RAL.SpellIdToText(spellId, 1)), AlertWChan);
			...
			if spellName == RAL_TEXT_SPELL_38 or spellName == RAL_TEXT_SPELL_39 or spellName == RAL_TEXT_SPELL_43 then
				TempUnit1 = RaidAlerter_GUIDToUnit(dstGUID);
				if TempUnit1 then
					...
					RAL.SendMSG(string.format(RAL_TEXT_ALERT_44,RAL.SpellIdToText(spellId, 1),srcName,dstName), AlertWChan);
				end
				return;
			end
		end
		if RaidAlerter_SET.TANK_LastStand then
			if spellName == RAL_TEXT_SPELL_2 or spellName == RAL_TEXT_SPELL_36 or spellName == RAL_TEXT_SPELL_44 or spellName == RAL_TEXT_SPELL_46 then
				TempUnit1 = RaidAlerter_GUIDToUnit(srcGUID);
				if TempUnit1 then
					RAL.SendMSG(string.format(RAL_TEXT_ALERT_16,srcName,RAL.SpellIdToText(spellId, 1)), AlertWChan);
				end
			...
			if spellName == RAL_TEXT_SPELL_45 or spellName == RAL_TEXT_SPELL_53 then
				TempUnit1 = RaidAlerter_GUIDToUnit(dstGUID);
				if TempUnit1 then
					if srcGUID == UnitGUID("player") then
						RaidAlerter.AddSCRMsg(string.format(RAL_TEXT_ALERT_44,RAL.SpellIdToText(spellId, 0, 1),RAL.ToPink(RAL_TEXT_YOU),RaidAlerter_ToClassColorNameText(dstName)));
		...
		if spellName == RAL_TEXT_SPELL_37 or spellName == RAL_TEXT_SPELL_50 or spellName == RAL_TEXT_SPELL_51 then		--专注魔法、能量灌注、激活：只在本机显示提示，玩家属于无关人员则不予显示
			if not(IsRaidLeader() or IsRaidOfficer() or UnitPowerType("player")==0) then
				return;
			end
			TempUnit1 = RaidAlerter_GUIDToUnit(srcGUID);
			if TempUnit1 then
		...
		if spellName == RAL_TEXT_SPELL_5 then
	...
	if eventtype == "SPELL_AURA_BROKEN_SPELL" or eventtype == "SPELL_AURA_BROKEN" then		--4.1似乎无效了
		if (spellName == RAL_TEXT_SPELL_9 or spellName == RAL_TEXT_BUFF_11 or spellName == RAL_TEXT_SPELL_10 or spellName == RAL_TEXT_SPELL_11 or spellName == RAL_TEXT_SPELL_12) then
			if RaidAlerter_SET.Break_Poly then
				...
				amount = amount or RAL_TEXT_SPELL_29;
				if not TempUnit2 then
					local DeText = "";
					local PolymorphTactic = false;
					if (spellName == RAL_TEXT_SPELL_9 or spellName == RAL_TEXT_BUFF_11) then DeText = RAL_TEXT_ALERT_24; end
					if (spellName == RAL_TEXT_SPELL_10) then DeText = RAL_TEXT_ALERT_25; end
					if (spellName == RAL_TEXT_SPELL_11) then DeText = RAL_TEXT_ALERT_26; end
					if (spellName == RAL_TEXT_SPELL_12) then DeText = RAL_TEXT_ALERT_27; end
					if TempUnit1 then
						if spellName == RAL_TEXT_SPELL_9 or spellName == RAL_TEXT_BUFF_11 then
						...
						if not PolymorphTactic then
							RAL.SendMSG(string.format(RAL_TEXT_ALERT_28,DeText,srcName,RaidAlerter_GetPetMaster(srcGUID),RaidAlerter_GUIDTOICONTEXT(dstGUID)..dstName,RAL.SpellIdToText(auraType, 1)), AlertChan, 0, 1, "BC"..dstGUID);	--刷屏限制：1秒
							RAL.SOUND(2);
						end
					elseif srcName then
						if (UnitAffectingCombat("player")==1 or UnitIsDead("player")) then
		...
		if eventtype == "SPELL_DAMAGE" or eventtype == "SWING_DAMAGE" or eventtype == "RANGE_DAMAGE" or eventtype == "SPELL_PERIODIC_DAMAGE" then
			if dstGUID == BCC_Check_dstGUID then
				...
				if not TempUnit2 then
					...
					if (BCC_Check_spellName == RAL_TEXT_SPELL_11) then DeText = RAL_TEXT_ALERT_26; end
	...
	if eventtype == "SPELL_DISPEL" or eventtype == "SPELL_AURA_DISPELLED" then
		if (spellName == RAL_TEXT_SPELL_13 or spellName == RAL_TEXT_SPELL_14 or spellName == RAL_TEXT_SPELL_15) then
			if RaidAlerter_SET.Dispel_Magic then
				...
				if (TempUnit1 and (not TempUnit2)) then
					...
					if srcGUID == UnitGUID("player") then
						RaidAlerter.AddSCRMsg(string.format(RAL_TEXT_ALERT_29,RAL.ToPink(RAL_TEXT_YOU),icon..RAL.ToRed(dstName),RAL.ToCyan(RAL.SpellIdToText(auraType, 0, 1))));
					end
					RAL.SendMSG(string.format(RAL_TEXT_ALERT_29,srcName,icon..dstName,RAL.SpellIdToText(auraType, 1)), AlertChan, 0, 0.5, "DM"..srcGUID);		--防止未来版本战斗记录可能改变导致的群驱刷屏
				end
			end
			return;
		end
	...
	if eventtype == "SPELL_MISSED" then
		...
		or spellName == RAL_TEXT_SPELL_9 or spellName == RAL_TEXT_BUFF_11 or spellName == RAL_TEXT_SPELL_20 or spellName == RAL_TEXT_SPELL_16 or spellName == RAL_TEXT_SPELL_13
		or spellName == RAL_TEXT_SPELL_14 or spellName == RAL_TEXT_SPELL_21 or spellName == RAL_TEXT_SPELL_5) then
			if ((not RaidAlerter_SET.TANK_Taunt) and (spellName == RAL_TEXT_SPELL_17 or spellName == RAL_TEXT_SPELL_18
			or spellName == RAL_TEXT_SPELL_19 or spellName == RAL_TEXT_SPELL_32)) then return; end
			...
			if ((not RaidAlerter_SET.RES_Polymorph) and (spellName == RAL_TEXT_SPELL_9 or spellName == RAL_TEXT_BUFF_11 or spellName == RAL_TEXT_SPELL_20)) then return; end
	...
	if eventtype == "SPELL_INTERRUPT" then
		if RaidAlerter_SET.Break_Magic then
			...
			if TempUnit1 then
				local icon = RaidAlerter_GUIDTOICONTEXT(dstGUID);
				if srcGUID == UnitGUID("player") then
					RaidAlerter.AddSCRMsg(string.format(RAL_TEXT_ALERT_34,RAL.ToPink(RAL_TEXT_YOU)..RAL.SpellIdToText(spellId, 1, 1),icon..RaidAlerter_ToClassColorNameText(dstName),RAL.ToCyan(RAL.SpellIdToText(auraType, 0, 1))));
				end
				RAL.SendMSG(string.format(RAL_TEXT_ALERT_34,srcName..RAL.SpellIdToText(spellId, 1),icon..dstName,RAL.SpellIdToText(auraType, 1)), AlertChan, 0, 0.2, "BM"..srcGUID);		--防DZ刀扇刷屏
				return;
			end
		end
		return;
	...
	if eventtype == "SPELL_SUMMON" then
		if RaidAlerter_SET.TANK_ShieldWall then
			if spellName == RAL_TEXT_SPELL_35 then
				TempUnit1 = RaidAlerter_GUIDToUnit(srcGUID);
				if TempUnit1 then
			...
			if spellName == RAL_TEXT_SPELL_42 or spellName == RAL_TEXT_SPELL_52 then
				TempUnit1 = RaidAlerter_GUIDToUnit(srcGUID);
				if TempUnit1 then
					RAL.SendMSG(string.format(RAL_TEXT_ALERT_39,srcName,RAL.SpellIdToText(spellId, 1)), AlertWChan);
					RaidAlerter.AddSCRMsg(string.format(RAL_TEXT_ALERT_39,RaidAlerter_ToClassColorNameText(srcName),RAL.SpellIdToText(spellId, 0, 1)));
		...
		if RaidAlerter_SET.SpellSummon then
			if spellName == RAL_TEXT_SPELL_7 then
				TempUnit1 = RaidAlerter_GUIDToUnit(srcGUID);
				if TempUnit1 then
					RAL.SendMSG(string.format(RAL_TEXT_ALERT_39,srcName,RAL.SpellIdToText(spellId, 1)), AlertWChan, 0, 3, "SPELLSUMMON"..srcGUID);	--刷屏限制：3秒
					RaidAlerter.AddSCRMsg(string.format(RAL_TEXT_ALERT_39,RaidAlerter_ToClassColorNameText(srcName),RAL.SpellIdToText(spellId, 0, 1)));
				end
				return;
			end
			...
			if (healthPercent > 0) then
				if (RaidAlerter_Alerter_System.BossHealthPecentTMP - healthPercent >= 1) then
					if (healthPercent <= RaidAlerter_SET.BossHealthPecent) then
						RAL.SendMSG("**["..healthPercent.."%]"..UnitName(unit.."target").."**", "RAID", 0, 1.5, "BossHPP");
						RaidAlerter_Alerter_System.BossHealthPecentTMP = healthPercent;
						return;
					else
						if (floor((RaidAlerter_Alerter_System.BossHealthPecentTMP-1)/10)-floor((healthPercent-1)/10)>=1) then
							if RaidAlerter_BattleTime_Record then
								local m, s = RaidAlerter_SecondsToTime(RaidAlerter_GetTimer("BattleTime_Record"));
								if m == 0 then
									RAL.SendMSG("**["..healthPercent.."%]"..UnitName(unit.."target").." ("..string.format(RAL_TEXT_TIP_4,s)..")**", "RAID");
								else
									RAL.SendMSG("**["..healthPercent.."%]"..UnitName(unit.."target").." ("..string.format(RAL_TEXT_TIP_5,m,s)..")**", "RAID");
								end
							else
								RAL.SendMSG("**["..healthPercent.."%]"..UnitName(unit.."target").."**", "RAID", 0, 1.5, "BossHPP");
							end
							RaidAlerter_Alerter_System.BossHealthPecentTMP = healthPercent;
							CurBoss_GUID = UnitGUID(unit.."target");
							return;
						end
					end
				end
		...
		if RaidAlerter_GetTimer("BossDangerThreatCheck") > 5 then
			if RaidAlerter_IsBossUnit(unit) then
				...
				if DangerNames ~= "" and RaidAlerter_SET.OT_OnOff then
					RAL.SendMSG(string.format(RAL_TEXT_ALERT_41, DangerNames, BossICON..Bossname), "RAID");
				end
			end
...
function RaidAlerter_OTAlert(Bossname, OTname, BossICON)
	if RaidAlerter_SET.OT_OnOff then
		RAL.SendMSG(string.format(RAL_TEXT_ALERT_1, BossICON..Bossname, OTname), "RAID");		--"RAID"在PARTY时会自动置换
...
--TANK判定
function RaidAlerter_TestIsMtList(unit)
	if oRA or CT_RA_MainTanks then		--oRA2和CTA下的RAL_Tanks未作判定，可能会属于替补
		if (UnitInRaid("player")) then
			if RaidAlerter_NameToGroup(UnitName(unit)) > RaidAlerter_SET.RAIDMODE_MAX_GROUP then
				return false;
			end
		end
	end
	if RaidAlerter_TestMtHasSet() then
		...
		for i = 1, 5 do
			if RAL_Tanks[i] then
				if RaidAlerter_NameToUnit(RAL_Tanks[i]) then
					if RAL_Tanks[i] == UnitName(unit) then
						return true;
					end
				end
			end
		...
		if (playerClass==RAL_TEXT_WARRIOR) or (playerClass==RAL_TEXT_DEATHKNIGHT) then
			if UnitInRaid("player") then
				if UnitHealthMax(unit) > (RaidHPMAXAVG*1.25) then
		...
		elseif (playerClass==RAL_TEXT_DRUID) then		--熊德
			if UnitInRaid("player") then
				...
				while (UnitBuff(unit, i)) do
					if (string.find(UnitBuff(unit, i), RAL_TEXT_BUFF_3)) then
						return true;
					end
					i = i + 1;
				end
		...
		elseif (playerClass==RAL_TEXT_PALADIN) then		--防骑
			if UnitInRaid("player") then
				...
				local i = 1;
				while (UnitBuff(unit, i)) do
					if (string.find(UnitBuff(unit, i), RAL_TEXT_BUFF_21)) then
...
function RaidAlerter_IsBossUnit(unit)
	if UnitExists(unit) then
		...
		elseif GetNumPartyMembers() > 0 then
			...
			PartyHPMAXAVG = PartyHPMAXAVG/(GetNumPartyMembers()+1);
...
function RaidAlerter_TestEnemyIsMe_Party()
	...
	if (Enemy_control_Count > GetNumPartyMembers()/2 ) then
		return true;
	else
		return false;
	end
					...
					elseif ( RaidAlerter_Alerter_BeControled[unit] == 1000)then
						if RaidAlerter_SET.PolyDispel then
							if RaidAlerter_GetTimer("DEP"..UnitName("raid"..id))>5 then		--同一人5秒内只报一次
								RAL.SendMSG(string.format(RAL_TEXT_ALERT_8,UnitName("raid"..id)),"RAID");
								SetRaidTargetIcon("raid"..id, 8);
								RaidAlerter_Alerter_System["lasticon"] = UnitName("raid"..id);
...
function RaidAlerter_GUIDToUnit(GUID)
	if not RAL_MEMBERS_GUID[GUID] then
		return false;
	end
	return RAL_MEMBERS_GUID[GUID].unitid;
end
...
function RaidAlerter_SetAddonMessage(ARG_1,msg)
	...
	if ARG_1=="RAL_CHECKVER" or ARG_1=="RAL_CHECKVERREPL" then SendAddonMSG = true;end

	if (UnitInRaid("player")) then
		if ARG_1=="RAL_SELECT" or ARG_1=="RAL_CHECKVER" or ARG_1=="RAL_CHECKVERREPL" then
			SendAddonMSG = true;
			SendAddonMSGCHAN = "RAID";
		end
		if (IsRaidLeader() or IsRaidOfficer()) then
			SendAddonMSG = true;
			SendAddonMSGCHAN = "RAID";
...
function RaidAlerter_SendAddonMessage()
	if not RAL_UIMSG_SENDED then
		if RaidAlerter_GetTimer("RAL_UIMSG_TIME") >= RAL_UIMSG_TIMELIMIT then		--4.0后SendAddonMessage()使用频率限制?
			SendAddonMessage(RAL_UIMSG_PREFIX,RAL_UIMSG_MSG,RAL_UIMSG_CHAN);
...
function RAL.SendMSG(msg, chan, ForceSend, CheckTime, MsgID)
	...
	if not(chan=="MYCHAN" or chan=="MYSCR" or chan=="MYCHANandSCR" or chan=="SAY" or chan=="YELL" or chan=="PARTY" or chan=="PARTY_RW" or chan=="RAID" or chan=="RAID_WARNING") then
		return;
	end
	if not UnitInRaid("player") then
	...
	if (chan=="RAID" or chan=="RAID_WARNING") then
		if ((IsRaidLeader() or IsRaidOfficer()) and (RaidAlerter_SYNC_SELECT_TOME==1)) or (chan=="RAID" and ForceSend == 1) then
			SendChatMessage(msg,chan);
			return;
