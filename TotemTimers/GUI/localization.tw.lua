...
L["Clickthrough"] = "點擊" -- Needs review
L["Clickthrough Desc"] = "禁止任何點擊功能按鈕的計時器" -- Needs review
L["Crowd Control"] = "控場選項" -- Needs review
L["Down"] = "下"
L["Earth"] = "大地"
L["Enable"] = "啟用"
L["Fire"] = "火焰"
...
L["Fulmination Aura"] = "撼天雷電光環" -- Needs review
L["Fulmination Aura Desc"] = "如果使用魔獸世界內置的PowerAuras並且閃電盾堆疊到9層時，則顯示了一個光環圍繞你的角色。" -- Needs review
L["Fulmination Glow"] = "撼天雷電光環" -- Needs review
L["Fulmination Glow Desc"] = "如果閃電盾堆疊到9層時，讓大地震擊冷卻計時器與動作列按鈕顯示大地震擊輝光。" -- Needs review
L["General"] = "一般"
L["Hide Blizzard Timers"] = "隱藏內建計時"
L["Hide Default Totem Bar"] = "隱藏預設圖騰條"
L["Hide Default Totem Bar Desc"] = "如果你取消這個你應該重新載入你的界面。" -- Needs review
...
L["Stop Pulse"] = "停止脈衝" -- Needs review
L["Stop Pulse Desc"] = "\"如果一個計時器停止其圖標會出現一個大可見脈衝效果\"" -- Needs review
L["Time Color"] = "計時顏色"
L["Time Font"] = "計時字型"
...
L["Button 4"] = "按鈕4"
L["ES Charges only"] = "只有大地之盾的消耗" -- Needs review
...
L["ES Main Tank Desc"] = "滑鼠停留時顯示了一個選單，裡面包含多達 4個你隊伍/團隊中的主坦克。" -- Needs review
L["ES Main Tank menu"] = "大地之盾主坦選單" -- Needs review
...
L["Duration"] = "期間" -- Needs review
L["ECD Button Size"] = "增強冷卻按鈕大小"
L["ECD Font Size"] = "增強冷卻字型大小"
L["EnhanceCDs"] = "增強冷卻設定"
L["Flame Shock on top"] = "烈焰震擊在頂部" -- Needs review
L["Flame Shock on top desc"] = "顯示烈焰震擊時間與氣旋武器條在冷卻計時器上方" -- Needs review
L["Hide OOC Desc"] = "改變這個設定下一次戰鬥才會生效"
L["Hide out of combat"] = "離開戰鬥隱藏"
L["Lava Surge Aura"] = "熔岩奔騰光環" -- Needs review
L["Lava Surge Aura Desc"] = "如果使用魔獸世界內置的熔岩奔騰特效PowerAuras，則顯示了一個光環圍繞你的角色。" -- Needs review
L["Lava Surge Glow"] = "熔岩奔騰輝光" -- Needs review
L["Lava Surge Glow Desc"] = "當熔岩奔騰特效發動時，讓熔岩爆發的冷卻時間計時器和動作列按鈕發出熔岩爆發的輝光。" -- Needs review
