...
TrinketMenu.BAG = L["Bag"] -- 7th return of GetItemInfo on a normal bag
TrinketMenu.ENGINEERING_BAG = L["Engineering Bag"] -- 7th return of GetItemInfo on an engineering bag
TrinketMenu.TRADE_GOODS = L["Trade Goods"] -- 6th return of GetItemInfo on most engineered trinkets
TrinketMenu.DEVICES = L["Devices"] -- 7th return of GetItemInfo on most engineered trinkets
TrinketMenu.REQUIRES_ENGINEERING = L["Requires Engineering"] -- from tooltip when GetItemInfo ambiguous

--xmlLocale
Trinket_Opt_Options = L["Options"]
...
TrinketMenu_Version = 3.81
BINDING_HEADER_TRINKETMENU = "TrinketMenu"
setglobal("BINDING_NAME_CLICK TrinketMenu_Trinket0:LeftButton",L["Use Top Trinket"])
setglobal("BINDING_NAME_CLICK TrinketMenu_Trinket1:LeftButton",L["Use Bottom Trinket"])
...
function TrinketMenu.ResetSettings()
	StaticPopupDialogs["TRINKETMENURESET"] = {
		text = L["Are you sure you want to reset TrinketMenu to default state and reload the UI?"],
