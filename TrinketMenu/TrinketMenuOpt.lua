...
local L = wsLocale:GetLocale("TrinketMenu")

TrinketMenu.CheckOptInfo = {
{"ShowIcon","ON",L["Minimap Button"],L["Show or hide minimap button."]},
{"SquareMinimap","OFF",L["Square Minimap"],L["Move minimap button as if around a square minimap."],"ShowIcon"},
{"CooldownCount","OFF",L["Cooldown Numbers"],L["Display time remaining on cooldowns ontop of the button."]},
{"TooltipFollow","OFF",L["At Mouse"],L["Display all tooltips near the mouse."],"ShowTooltips"},
{"KeepOpen","OFF",L["Keep Menu Open"],L["Keep menu open at all times."]},
{"KeepDocked","ON",L["Keep Menu Docked"],L["Keep menu docked at all times."]},
{"Notify","OFF",L["Notify When Ready"],L["Sends an overhead notification when a trinket's cooldown is complete."]},
{"DisableToggle","OFF",L["Disable Toggle"],L["Disables the minimap button's ability to toggle the trinket frame."],"ShowIcon"},
{"NotifyChatAlso","OFF",L["Notify Chat Also"],L["Sends notifications through chat also."]},
{"Locked","OFF",L["Lock Windows"],L["Prevents the windows from being moved, resized or rotated."]},
{"ShowTooltips","ON",L["Show Tooltips"],L["Shows tooltips."]},
{"NotifyThirty","ON",L["Notify At 30 sec"],L["Sends an overhead notification when a trinket has 30 seconds left on cooldown."]},
{"MenuOnShift","OFF",L["Menu On Shift"],L["Check this to prevent the menu appearing unless Shift is held."]},
{"TinyTooltips","OFF",L["Tiny Tooltips"],L["Shrink trinket tooltips to only their name, charges and cooldown."],"ShowTooltips"},
{"SetColumns","OFF",L["Wrap at: "],L["Define how many trinkets before the menu will wrap to the next row.\n\nUncheck to let TrinketMenu choose how to wrap the menu."]},
{"LargeCooldown","ON",L["Large Numbers"],L["Display the cooldown time in a larger font."],"CooldownCount"},
{"ShowHotKeys","ON",L["Show Key Bindings"],L["Display the key bindings over the equipped trinkets."]},
{"StopOnSwap","OFF",L["Stop Queue On Swap"],L["Swapping a passive trinket stops an auto queue.  Check this to also stop the auto queue when a clickable trinket is manually swapped in via TrinketMenu.  This will have the most use to those with frequent trinkets marked Priority."]},
{"HideOnLoad","OFF",L["Close On Profile Load"],L["Check this to dismiss this window when you load a profile."]},
{"RedRange","OFF",L["Red Out of Range"],L["Check this to red out worn trinkets that are out of range to a valid target.  ie, Gnomish Death Ray and Gnomish Net-O-Matic."]},
{"MenuOnRight","OFF",L["Menu On Right-Click"],L["Check this to prevent the menu from appearing until either worn trinket is right-clicked.\n\nNOTE: This setting CANNOT be changed while in combat."]},
}

-- table.insert(TrinketMenu.CheckOptInfo,)

TrinketMenu.TooltipInfo = {
{"TrinketMenu_LockButton",L["Lock Windows"],L["Prevents the windows from being moved, resized or rotated."]},
{"TrinketMenu_Trinket0Check",L["Top Trinket Auto Queue"],L["Check this to enable auto queue for this trinket slot.  You can also Alt+Click the trinket slot to toggle Auto Queue."]},
{"TrinketMenu_Trinket1Check",L["Bottom Trinket Auto Queue"],L["Check this to enable auto queue for this trinket slot.  You can also Alt+Click the trinket slot to toggle Auto Queue."]},
{"TrinketMenu_SortPriority",L["High Priority"],L["When checked, this trinket will be swapped in as soon as possible, whether the equipped trinket is on cooldown or not.\n\nWhen unchecked, this trinket will not equip over one already worn that's not on cooldown."]},
{"TrinketMenu_SortDelay",L["Swap Delay"],L["This is the time (in seconds) before a trinket will be swapped out.  ie, for Earthstrike you want 20 seconds to get the full 20 second effect of the buff."]},
{"TrinketMenu_SortKeepEquipped",L["Pause Queue"],L["Check this to suspend the auto queue while this trinket is equipped. ie, for Carrot on a Stick if you have a mod to auto-equip it to a slot with Auto Queue active."]},
{"TrinketMenu_Profiles",L["Profiles"],L["Here you can load or save auto queue profiles."]},
{"TrinketMenu_Delete",L["Delete"],L["Remove this trinket from the list.  Trinkets further down the list don't affect performance at all.  This option is merely to keep the list managable. Note: Trinkets in your bags will return to end of the list."]},
{"TrinketMenu_ProfilesDelete",L["Delete Profile"],L["Remove this profile."]},
{"TrinketMenu_ProfilesLoad",L["Load Profile"],L["Load a queue order for the selected trinket slot.  You can double-click a profile to load it also."]},
{"TrinketMenu_ProfilesSave",L["Save Profile"],L["Save the queue order from the selected trinket slot.  Either trinket slot can use saved profiles."]},
{"TrinketMenu_ProfileName",L["Profile Name"],L["Enter a name to call the profile.  When saved, you can load this profile to either trinket slot."]},
}
...
function TrinketMenu.OptColumnsSlider_OnValueChanged(self)
	if TrinketMenuOptions then
		...
		TrinketMenu_OptColumnsSliderText:SetText(TrinketMenuOptions.Columns..L[" trinkets"])
