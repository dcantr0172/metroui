...
local function VUHDO_mouseOverTargetValidator(anInfo, _)
	if (anInfo["isPet"] and (VUHDO_RAID[anInfo["ownerUnit"]] or tEmptyInfo)["isVehicle"]) then
		return anInfo["ownerUnit"] == VUHDO_getCurrentMouseOver(), nil, 100, -1, 100, nil, nil, nil, nil, nil, nil;
	else
		return anInfo["unit"] == VUHDO_getCurrentMouseOver(), nil, 100, -1, 100, nil, nil, nil, nil, nil, nil;
	end
end
