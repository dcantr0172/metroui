...
local function VUHDO_assignDefaultSpells()
	...
	VUHDO_CLASS_DEFAULT_SPELL_ASSIGNMENT = VUHDO_decompressIfCompressed(VUHDO_CLASS_DEFAULT_SPELL_ASSIGNMENT);
...
function VUHDO_loadSpellArray()
	...
	VUHDO_CLASS_DEFAULT_SPELL_ASSIGNMENT = VUHDO_compressTable(VUHDO_CLASS_DEFAULT_SPELL_ASSIGNMENT);
	-- Maus gegnerisch
	...
	table.wipe(VUHDO_DEFAULT_SPELL_ASSIGNMENT);
	table.wipe(VUHDO_DEFAULT_HOSTILE_SPELL_ASSIGNMENT);
	table.wipe(VUHDO_DEFAULT_SPELLS_KEYBOARD);
...
function VUHDO_loadDefaultConfig()
	...
	if (tonumber(tTocVersion or 0) >= 40300) then
		-- 4.3 Dragon Soul
