...
function VUHDO_loadDefaultBouquets()
	...
	VUHDO_DEFAULT_BACKGROUND_BOUQUETS = VUHDO_compressTable(VUHDO_DEFAULT_BACKGROUND_BOUQUETS);

	if (VUHDO_BOUQUETS["VERSION"] < 3) then
		VUHDO_BOUQUETS["VERSION"] = 3;
		VUHDO_addDefaultBouquet(VUHDO_DEFAULT_ALTERNATE_POWERS_BOUQUET);
	end
	VUHDO_DEFAULT_ALTERNATE_POWERS_BOUQUET = VUHDO_compressTable(VUHDO_DEFAULT_ALTERNATE_POWERS_BOUQUET);
	...
	VUHDO_DEFAULT_HOLY_POWER_BOUQUET = VUHDO_compressTable(VUHDO_DEFAULT_HOLY_POWER_BOUQUET);
	VUHDO_DEFAULT_ROLE_ICON_BOUQUET = VUHDO_compressTable(VUHDO_DEFAULT_ROLE_ICON_BOUQUET);

	if (VUHDO_BOUQUETS["VERSION"] < 6) then
		VUHDO_BOUQUETS["VERSION"] = 6;
		VUHDO_addDefaultBouquet(VUHDO_DEFAULT_AOE_ADVICE_BOUQUET);
	end
	VUHDO_DEFAULT_AOE_ADVICE_BOUQUET = VUHDO_compressTable(VUHDO_DEFAULT_AOE_ADVICE_BOUQUET);

	if (VUHDO_BOUQUETS["VERSION"] < 7) then
		VUHDO_BOUQUETS["VERSION"] = 7;
		VUHDO_addDefaultBouquet(VUHDO_DEFAULT_WRACK_BOUQUET);
	end
	VUHDO_DEFAULT_WRACK_BOUQUET = VUHDO_compressTable(VUHDO_DEFAULT_WRACK_BOUQUET);

	if (VUHDO_BOUQUETS["VERSION"] < 8) then
		VUHDO_BOUQUETS["VERSION"] = 8;
		VUHDO_addDefaultBouquet(VUHDO_DEFAULT_DIRECTION_ARROW_BOUQUET);
	end
	VUHDO_DEFAULT_DIRECTION_ARROW_BOUQUET = VUHDO_compressTable(VUHDO_DEFAULT_DIRECTION_ARROW_BOUQUET);

	if (VUHDO_BOUQUETS["VERSION"] < 9) then
		VUHDO_BOUQUETS["VERSION"] = 9;
		VUHDO_addDefaultBouquet(VUHDO_DEFAULT_GRID_BOUQUETS);
	end
	VUHDO_DEFAULT_GRID_BOUQUETS = VUHDO_compressTable(VUHDO_DEFAULT_GRID_BOUQUETS);

	if (VUHDO_BOUQUETS["VERSION"] < 10) then
		VUHDO_BOUQUETS["VERSION"] = 10;
		VUHDO_addDefaultBouquet(VUHDO_DEFAULT_ROLE_COLOR_BOUQUET);
	end
	VUHDO_DEFAULT_ROLE_COLOR_BOUQUET = VUHDO_compressTable(VUHDO_DEFAULT_ROLE_COLOR_BOUQUET);
