...
function AuctionLite:AuctionFrameTab_OnClick_Hook(tab, arg)
  ...
  elseif index == SellTabIndex then
    AuctionFrameTopLeft:SetTexture("Interface\\AddOns\\Wowshell_EasyAH\\auctionlite\\Images\\SellFrame-TopLeft");
    AuctionFrameTop:SetTexture("Interface\\AddOns\\Wowshell_EasyAH\\auctionlite\\Images\\SellFrame-Top");
    AuctionFrameTopRight:SetTexture("Interface\\AddOns\\Wowshell_EasyAH\\auctionlite\\Images\\SellFrame-TopRight");
    AuctionFrameBotLeft:SetTexture("Interface\\AddOns\\Wowshell_EasyAH\\auctionlite\\Images\\SellFrame-BotLeft");
    AuctionFrameBot:SetTexture("Interface\\AddOns\\Wowshell_EasyAH\\auctionlite\\Images\\SellFrame-Bot");
    AuctionFrameBotRight:SetTexture("Interface\\AddOns\\Wowshell_EasyAH\\auctionlite\\Images\\SellFrame-BotRight");
