...
--	
--	preview.testUnit["focustarget"](units)
...
ns:spawn(function()
	...
	--f:SetPoint('TOPLEFT', ns.units.focus, 'BOTTOMRIGHT', -50, 25)
	--f:SetPoint(position.selfPoint, ns.unitFrames.focus, position.relationsPoint, position.x, position.y)
	ns.frameList[f] = true
...
--				toggleElement(_,"portrait",ns.unitFrames.focustarget.Portrait)
--			end,
--		},
--		raidIcon = {
--			type = "toggle",
...
--				toggleIndicators(_,"raidIcon",ns.unitFrames.focustarget.RaidIcon)
--			end,
--		},
--	
--	},
...
--    db = ns.db.profile
--
--    unitdb = ns.db:RegisterNamespace('focustarget', { profile = {
--            enabled = true,
--            tagonhealthbar = 'PERC',
--            tagonpowerbar = 'NONE',
--        }
...
--end)
--
--ns:RegisterModuleOptions('focustarget', {
--    type = 'group',
--    name = L['focustarget'],
--    order = ns.order(),
--    args = {
