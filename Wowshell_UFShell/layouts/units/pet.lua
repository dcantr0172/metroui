...
ns:spawn(function()
	...
	--f:SetPoint(position.selfPoint, ns.unitFrames.player, position.relationsPoint, position.x, position.y)
	frame = f
	ns.frameList[f] = true
	ns.unitFrames.pet = f
				...
				hpColor = {
					...
					args = {
						colorType = {
							...
							name = L["Color type"],
							desc = L["Color type"],
							values = {["colorSmooth"] = L["colorSmooth"],["colorHealth"] = L["colorHealth"],},
				...
				ppColor = {
					...
					args = {
						colorType = {
							...
							name = L["Color type"],
							desc = L["Color type"],
							values = {["colorPower"] = L["colorPower"],["colorCustom"] = L["colorCustom"]},
