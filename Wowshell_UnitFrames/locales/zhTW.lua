local L = wsLocale:NewLocale('wsUnitFrame', 'zhTW')
if not L then return end

L['Wowshell unit frame'] = '精靈頭像'
L['Options for wowshell unit frame.'] = '精靈頭像設置'
L['Advance settings'] = '高級設置'

L['You cannot unlock in combat'] = '無法在戰鬥時解鎖'
L['Double click to lock'] = '雙擊鎖定'
L['Click to toggle lock'] = '點擊鎖定/解鎖'
L['Please unlock wowshell unitframe in its config or minimap button'] = '請在精靈頭銜設置或點擊小地圖按鈕解鎖/鎖定'

L['General'] = '常規設置'
L['3D portrait'] = '3D頭像'
L['Use 3D portrait'] = '使用3D頭像'
L['Lock position'] = '鎖定位置'
L['Lock all frames'] = '鎖定所有頭像位置'
L['Reset position'] = '重設位置'
L['Reset all frames to default position'] = '將頭像移回原位'
L['Addon will disable after reload.'] = '插件將在重載後關閉'
L['Swich to bliz unit frame'] = '切換到暴雪头像'
L['Reload to switch'] = '重载后切换'

L['player'] = '玩家'
L['Elite texture'] = '精英材質'
L['Always show elite texture on player frame'] = '玩家頭像使用精英材質'
L['Sidebar'] = '側邊欄增強'
L['Enable sidebar'] = '啟用側邊欄增強'
L['Combat feedback text'] = '頭像傷害反饋'
L['Tag texts'] = '標籤文字'
L['toggle combat feedback text for player'] = '在頭像上顯示收到的傷害和治療動畫'
L['Text on health bar'] = '血條上文字'
L['The text show on health bar'] = '血條上顯示的文字'
L['Text on power bar'] = '法力條上文字'
L['The text show on power bar'] = '發力條上的文字'
L['Text on sidebar 1'] = '增強欄1文字'
L['The text show on sidebar 1'] = '增強欄1上的文字'
L['Text on sidebar 2'] = '增強欄2文字'
L['The text show on sidebar 2'] = '增強欄2上的文字'
L['Text on sidebar 3'] = '增強欄3文字'
L['The text show on sidebar 3'] = '增強欄3上的文字'

L['Aura cooldown'] = '增益計時動畫'
L['Show aura cooldown'] = '顯示增益/減益計時動畫'
L['Cast by me only'] = '只顯示我釋放的'
L['Only show cooldown on those that cast by me'] = '只顯示我釋放的增益/減益計時動畫'

L['target'] = '目標'
L['Aura on top'] = '增益置於頂端'
L['Display aura on the top of the frame'] = '將增益框放置在目標頭像頂端'
L['Castbar'] = '施法條'
L['Enable castbar'] = '開啟施法條'
L['Highlight debuffs cast by me'] = '高亮自己施放的減益'
L['Text on health bar left'] = '血條左側文字'
L['The text show on health bar left'] = '血條左側文字'
L['Text on power bar left'] = '法力條左側文字'
L['The text show on power bar left'] = '發力條左側文字'

L['tot'] = '目標的目標'
--L['Enabled']
L['Enable target of target'] = '啟用目標的目標'
L['Enable auras'] = '顯示增益/減益'
L['Enable party pet frame'] = "啟用小隊寵物"
L['Enable party pet frame. need reloadui'] = "啟用小隊寵物,需要重載介面"
L["Enable auras"] = "顯示BUFF/DEBUFF"
L['totot'] = '目標的目標的目標'
--L['Enabled']
L['Enable target of target of target'] = '啟用目標的目標的目標'

L['focus'] = '焦點'
--L['Aura on top'],
--L['Display aura on the top of the frame'],

L['focustarget'] = '焦點的目標'
L['Enabled'] = '啟用'
L['Enable focus target'] = '啟用焦點的目標'

L['focustargettarget'] = '焦點目標的目標'
L['Enable focus\'s target of target'] = '啟用焦點目標的目標'

L['partytarget'] = '隊友目標'
--L['Enable']
L['Enable party target'] = '啟用隊友目標'
L['Color by target\'s reaction'] = '使用目標關係染色'
L['Color health bar by target\'s reaction'] = '使用與目標的關係情況染色'

L['party'] = '小隊'
L['Enabled'] = '啟用'
L['Enable party frame'] = '啟用小隊'
L['Show party in raid'] = '在團隊中顯示'
L['Show party frame in raid'] = '在團隊中顯示小隊框架'
L['Text beside health bar'] = '血條右側文字'
L['The text besides the health bar'] = '血條右側文字'
L['Text besides power bar'] = '法力條右側文字'
L['The text besides the power bar'] = '發力條右側文字'
L['Side info bar'] = '增強信息欄'
L['Toggle side info bar'] = '啟用增強信息欄'
L['Party cast'] = '隊伍施法'
L['Toggle party cast'] = '啟用隊伍施法, 具體設置請在隊伍施法設置中設置'
...
L['pet'] = '寵物'
L['wsUnitFrame_ToT'] = '目標的目標'
L['wsUnitFrame_ToToT'] = '目標的目標的目標'

L['arena'] = '競技場'
L['Enable arena'] = '啟用競技場'

L['arenatarget'] = '競技場目標'
L['Enable arena target'] = '啟用競技場目標'

for i = 1, 4 do
    L['party' .. i .. ''] = '隊友' .. i
    L['party' .. i .. 'pet'] = '隊友' .. i .. '寵物'
    L['party' .. i .. 'target'] = '隊友' .. i .. '目標'
end

L['Please shift click the frame to set/clear focus'] = 'shift點擊頭像設置/取消焦點'
L['The settings will take effect after reload.'] = '設置將在重載後應用'

L["Party cast"] = '隊友施法'
L["Spell buttons for the party members"] = '隊友框體右邊的快捷施法按鈕'
L['Enable'] = '啟用'
L['Enable party cast frame'] = '啟用小隊施法'
L['Lock button'] = '鎖定按鈕'
L['Lock the buttons to prevent being messed up'] = '鎖定按鈕防止意外拖動'
L['Hide grid'] = '隱藏空按鈕'
L['Rank matters'] = '不自動升級法術等級'
L['Button number'] = '按鈕數量'

L['Color by target\'s reaction'] = "目標關係著色"
L['Color health bar by target\'s reaction'] = "根據目標關係著色生命條"
L["Enable buffs"] = "顯示Buff"
L["Enable debuffs"] = "顯示Debuff"



L["player"] = "玩家"
L["Portrait"] = "頭像"
L["Player's Portrait"] = "玩家的頭像"
L["Enable"] = "啟用"
L["Enable Portrait"] = "啟用頭像"
L["Width"] = "寬度"
L["Portrait's width"] = "設置頭像的寬度"
L["Height"] = "高度"
L["Portrait's height"] = "設置頭像的高度"
L["Portrait's position"] = "頭像位置"
L["Set your Portrait position"] = "設置頭像的位置"
L["LEFT"] = "左"
L["RIGHT"] = "右"
L["HealthBar"] = "生命條"
L["Player's healthBar"] = "玩家的生命條"
L["HealthBar's width"] = "生命條的寬度"
L["HealthBar's height"] = "生命條的高度"
L["HealthBar color"] = "生命條的顏色"
L["colorClass"] = "按職業染色"
L["colorSmooth"] = "按生命值染色"
L["PowerBar"] = "法力條"
L["Player's powerBar"] = "玩家的法力條"
L["Powerbar's width"] = "法力條的寬度"
L["Powerbar's height"] = "法力條的高度"
L["Enable player's castBar"] = "啟用玩家施法條"
L["Player's castBar"] = "玩家的施法條"
L["Castbar's width"] = "施法條的寬度"
L["Castbar's height"] = "施法條的高度"
L["CastIcon's size"] = "施法圖標的尺寸"
L["Aura"] = "Buff/Debuff"
L["Enable auras"] = "顯示Buff/Debuff"
L["The count of Buffs"] = "Buff的數量"
L["Set the count of Buffs"] = "設置Buff的數量"
L["The count of Debuffs"] = "Debuff的數量"
L["Set the count of Debuffs"] = "設置Debuff的數量"
L["Lines of the auras"] = "Buff/Debuff的行數"
L["Set how many lines of the auras"] = "設置Buff/Debuff的行數"
L["Auras's count perline"] = "每行的數量"
L["Set how many auras in a line"] = "設置每行顯示多少個Buff/Debuff"
L["ExpBar"] = "經驗條"
L["Enable Expbar,when you're max levels,it will be hidden"] = "是否開啟經驗條(當你處於滿級的情況下 經驗條將會自動隱藏)"
L["Indicators"] = "特定元素"
L["PvP icon"] = "PVP圖標"
L["Enable pvp icon"] = "顯示PVP圖標"
L["Size"] = "尺寸"
L["PvP icon's size"] = "PVP圖標的尺寸"
L["Leader icon"] = "隊長圖標"
L["Enable Leader icon"] = "顯示隊長圖標"
L["Leader icon's size"] = "隊長圖標的尺寸"
L["MasterLooter icon"] = "物品分配者圖標"
L["Enable MasterLooter icon"] = "顯示物品分配者圖標"
L["Resting icon"] = "休息狀態圖標"
L["Enable Resting icon"] = "顯示休息狀態圖標"
L["Resting icon's size"] = "休息狀態圖標的尺寸"
L["LFDRole icon"] = "團隊職責圖標"
L["Enable LFDRole icon"] = "顯示團隊職責圖標"
L["LFDRole icon's size"] = "團隊職責圖標的尺寸"
L["RaidIcon"] = "團隊標記"
L["Enable RaidIcon"] = "顯示團隊標記"
L["RaidIcon's size"] = "團隊標記的尺寸"
L["Tags"] = "標籤文字"
L["Tags of name"] = "主標籤"
L["Enable tags of name"] = "顯示主標籤"
L["Advance name tags"] = "高級標籤設置"
L["Set custom name tags"] = "設置自定義標籤"
L["Tags of Level"] = "副標籤"
L["Enable tags of Level"] = "顯示副標籤"
L["Advance level tags"] = "高級標籤設置"
L["Set custom level tags"] = "設置自定義標籤"
L["Tags of health"] = "生命值標籤"
L["Enable tags of hp"] = "顯示生命值標籤"
L["Advance hp tags"] = "高級生命值標籤設置"
L["Set custom hp tags"] = "設置自定義生命值標籤"
L["Tags of power"] = "法力值標籤"
L["Enable tags of mp"] = "顯示法力值標籤"
L["Advance mp tags"] = "高級法力值標籤設置"
L["Set custom mp tags"] = "設置自定義法力值標籤"
L["Portrait position"] = "頭像位置"
L["Group"] = "團隊"
L["Group options"] = "團隊設置"
L["Assistant"] = "團隊助理圖標"
L["Enable Assistant Icon"] = "顯示團隊助理圖標"
L["Assistant Icon's size"] = "團隊助理圖標尺寸"
L["ClassIcon"] = "職業圖標"
L["Enable ClassIcon"] = "顯示職業圖標"
L["ClassIcon's size"] = "職業圖標的尺寸"
L["boss"] = "首領"
L["bosstarget"] = "首領目標"
L["FULL"] = "遮罩"
L["NONE"] = "無"
...
L["AFK timer"] = "AFK 計時器"
L["AFK:%s"] = "AFK:%s"
L["Abbreviates unit names above 10 characters, \"Dark Rune Champion\" becomes \"D.R.Champion\" and \"Dark Rune Commoner\" becomes \"D.R.Commoner\"."] = "縮寫超過10個單詞的頭像名字, \"Dark Rune Champion\" 縮寫為 \"D.R.Champion\" 或 \"Dark Rune Commoner\" 縮寫為 \"D.R.Commoner\"."
L["Absolute incoming heal value, if 10,000 healing is incoming it will show 10,000."] = "精確顯示接受治療的治療量, 如 10,000 治療量顯示為 10,000."
L["Add"] = "增加"
L["Add new tag"] = "增加新的標籤"
L["Add new text"] = "增加新的文字"
L["Add tags"] = "增加標籤"
L["Adds %s to the list of units to be modified when you change values in this tab."] = "增加 %s 到頭像列表，你可以在這個選項卡裏修改參數值。"
L["Adds a bar indicating how much time is left on your ghoul timer, only used if you do not have a permanent ghoul."] = "在你的食尸鬼計時器上增加一個計時條指示器,.僅用於一個非永久性的食尸鬼."
L["Adds a bar indicating how much time is left on your mushrooms."] = "增加一個條,提示你的蘑菇還有多長時間消失" -- Needs review
L["Adds an empty bar that you can put text into as a way of uncluttering other bars."] = "增加一個可以放置文本的空的計量條."
L["Adds another mana bar to the player frame when you are in Bear or Cat form showing you how much mana you have."] = "當你在熊或貓形態下時在玩家頭像上增加一個額外的法力條."
L["Adds eclipse bars and how far into sun or moon eclipse is.."] = "增加月蝕條並顯示日蝕和月蝕."
L["Adds rune bars and timers before runes refresh to the player frame."] = "在符文刷新之前增加符文條和計時器到玩家頭像框體."
L["Adds temporary enchants to the buffs for the player."] = "為玩家的BUFF增加臨時附魔."
L["Adds totem bars with timers before they expire to the player frame."] = "在到期之前增加帶有計時器的圖騰條到玩家頭像框體."
L["Advanced"] = "高級"
L["Advanced tag management, allows you to add your own custom tags."] = "高級標籤管理,.允許你添加自定義的標籤."
...
L["Bar alpha"] = "计量条透明度"
L["Bar coloring for the moon portion of the eclipse bar."] = "月蚀条中月蚀部分的颜色."
L["Bar spacing"] = "计量条间距"
L["Bar texture"] = "背景材质"
L["Bars"] = "计量条"
L["Battlegrounds"] = "战场"
...
L["Border color"] = "边框颜色"
L["Border coloring of stealable or removable auras."] = "为可偷取或驱散的Buff/Debuff染色" -- Needs review
...
L["Energy"] = "能量"
L["Enlarge removable auras"] = "放大可驱散的Buff/Debuff" -- Needs review
...
L["colorPower"] = "按類型染色"
L["colorCustom"] = "自定義顏色"
L["Background and border"] = "背景和邊框"
L["CastbarIcon"] = "施法條圖標"
L["Castbar Text"] = "施法條文字"
L["Text Flag"] = "文字描邊"
L["NORMAL"] = "正常"
L["OUTLINE"] = "細描邊"
L["THICKOUTLINE"] = "粗描邊"
...
L["ParentTopleft"] = "左上方"
L["ParentTop"] = "正上方"
L["ParentTopright"] = "右上方"
L["ParentBottomleft"] = "左下方"
L["ParentBottomright"] = "右下方"
L["HealthLeft"] = "生命條左側"
L["HealthCenter"] = "生命條中央"
L["HealthRight"] = "生命條右側"
L["PowerLeft"] = "法力條左側"
L["PowerRight"] = "法力條右側"
L["PowerCenter"] = "法力條中央"
L["PortraitLeft"] = "頭像左側"
L["PortraitRight"] = "頭像右側"
L["PortraitCenter"] = "頭像中央"
L["CombatFeedbackText"] = "戰鬥傷害反饋"
L["Combat Icon"] = "戰鬥標記"
L["SpecialElement"] = "特殊元素"
L["ComboPoint"] = "連擊點"
L["Posistion"] = "位置"
L["Enter tags"] = "輸入標籤"
L["Font flag"] = "字體描邊"
...
--HELP's
L["Tags Custom Code"] = "|cffff2020自定義標籤文檔|r"
L["Tags notes"] = "以下文檔為標籤的代碼和意義(格式),方括號(包含方括號)中為標籤代碼,比如:|cff20ff20[curhp]|r,標籤代碼右邊的中文為該標籤代碼的意義(或格式),如果想要在一個標籤對象中使用多個標籤代碼的組合形式,請在組合的最後加上|cff20ff20[close]|r閉包標籤,比如:|cff20ff20[name][level][close]|r,這樣就能在同一個標籤中同時顯示名字以及等級了"
L["abscurhp"] = "|cff20ff20[abscurhp]|r:當前生命值(絕對值) 格式:10000"
L["absmaxhp"] = "|cff20ff20[absmaxhp]|r:最大生命值(絕對值) 格式:15000"
L["absolutehp"] = "|cff20ff20[absolutehp]|r:當前生命值(絕對值)/最大生命值(絕對值) 格式10000/15000"
L["curhp"] = "|cff20ff20[curhp]|r:當前生命值(科學計數) 格式:10k"
L["curmaxhp"] = "|cff20ff20[curmaxhp]|r:當前生命值(科學計數)/最大生命值(科學計數) 格式:10k/15k"
L["maxhp"] = "|cff20ff20[maxhp]|r:最大生命值(科學計數) 格式:15k"
L["perhp"] = "|cff20ff20[perhp]|r:當前生命值百分比 格式:75%"
L["smart:curmaxhp"] = "|cff20ff20[smart:curmaxhp]|r:當前生命值(長科學計數)/最大生命值(長科學計數) 格式:9,00,000/1.2m"
L["missinghp"] = "|cff20ff20[missinghp]|r:損失的血量 如果當前單位的生命值是滿的話.該標籤將不顯示"
L["abscurpp"] = "|cff20ff20[abscurpp]|r:當前法力值(絕對值) 格式:10000"
L["absmaxpp"] = "|cff20ff20[absmaxpp]|r:最大法力值(絕對值) 格式:15000"
L["absolutepp"] = "|cff20ff20[absolutepp]|r:當前法力值(絕對值)/最大生命值(絕對值) 格式:10000/15000"
L["curmaxpp"] = "|cff20ff20[curmaxpp]|r:當前法力值(科學計數)/最大法力值(科學計數) 格式:10k/15k"
L["curpp"] = "|cff20ff20[curpp]|r:當前法力值(科學計數) 格式:10k"
L["maxpp"] = "|cff20ff20[maxpp]|r:最大法力值(科學計數) 格式:15k"
L["perpp"] = "|cff20ff20[perpp]|r:當前法力值百分比 格式:75%"
L["smart:curmaxpp"] = "|cff20ff20[smart:curmaxpp]|r:當前法力值(長科學計數)/最大法力值(長科學計數) 格式 9,00,000/1.2m"
L["name"] = "|cff20ff20[name]|r:姓名"
L["colorname"] = "|cff20ff20[colorname]|r:姓名(以當前職業染色)"
L["defname"] = "|cff20ff20[def:name]|r:滿血將顯示姓名,否則將顯示損失的血量"
L["level"] = "|cff20ff20[level]|r:等級"
L["levelcolor"] = "|cff20ff20[levelcolor]|r:等級(以當前職業染色)"
L["smartlevel"] = "|cff20ff20[smartlevel]|r:根據單位類型顯示等級或'首領'或'精英'"
L["Party members's yOffset"] = "小隊成員間距"
L["yOffset,need to reloadui"] = "調整后的間距將在重載后生效"
L["tags"] = "標籤文字"
L["keybind"] = "快捷鍵"
L["keybind command"] = "|cffff2020快捷鍵命令|r"
L["HealthTag"] = "|cff69ccf0生命值類別標籤|r"
L["PowerTag"] = "|cff69ccf0法力值類別標籤|r"
L["NameTag"] = "|cff69ccf0姓名類別標籤|r"
L["LevelTag"] = "|cff69ccf0等級類別標籤|r"
L["Double click to lock/unlock the unit frame"] = "|cff69ccf0鼠標雙擊|r:解鎖頭像或鎖定頭像"
L["Press RightCtrl key down will create target's armory or db strings"] = "|cff69ccf0右側Ctrl鍵|r:點選目標使用該快捷鍵可以輸出該單位的英雄榜或者數據庫地址 方便玩家進行查詢"
L["Press RightAlt key down will create target's name strings"] = "|cff69ccf0右側Alt鍵|r:點選目標使用該快捷鍵可以輸出該單位的名字 方便玩家進行複製"
L["风格: "] = "風格"
L["点击切换头像风格. 如果显示不正常, 请重载界面"] = "點擊切換頭像風格. 如果顯示不正常, 請重載介面"
L["暴雪风格"] = "暴雪風格"
L["现代风格"] = "現代風格"
L["Show Blz's raid Frame"] = "顯示暴雪團隊框架"
